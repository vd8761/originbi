...
export const BEHAVIORAL_TEMPLATES = {
  D: {
    summary:
      'displays a <b>dominant and results-driven style</b>. They are assertive, decisive, and focused on achieving objectives. They thrive in leadership roles and are effective at driving change.',
    strengths: [
      'Decisive leadership',
  ...
  I: {
    summary:
      'displays an <b>influential and enthusiastic style</b>. They are optimistic, persuasive, and excel at building relationships. They bring energy and creativity to their teams.',
    strengths: [
  ...
  S: {
    summary:
      'displays a <b>steady and supportive style</b>. They are reliable, patient, and create harmonious team environments. They excel at maintaining stability and supporting colleagues.',
    strengths: [
      'Team collaboration',
  ...
  C: {
    summary:
      'displays a <b>conscientious and analytical style</b>. They are detail-oriented, systematic, and focused on quality. They excel in roles requiring precision and expertise.',
    strengths: [
      'Analytical thinking',
      'Quality focus',
      'Systematic approach',
  ...
  DI: {
    summary:
      'displays a <b>dominant and influential style (Di)</b>. They combine assertiveness with persuasiveness, making them effective at leading teams and driving results through people.',
    strengths: [
  ...
  DS: {
    summary:
      'displays a <b>dominant and steady style (Ds)</b>. They balance results-focus with team stability, providing consistent leadership while maintaining team morale.',
    strengths: [
      'Balanced leadership',
      'Strategic thinking',
      'Team stability',
  ...
  DC: {
    summary:
      'displays a <b>dominant and conscientious style (Dc)</b>. They combine drive with analytical precision, excelling in roles that require both leadership and technical expertise.',
    strengths: [
      'Strategic analysis',
  ...
  IS: {
    summary:
      'displays an <b>influential and steady style (Is)</b>. They combine enthusiasm with stability, creating positive team environments while maintaining consistent performance.',
    strengths: [
      'Team motivation',
      'Relationship building',
  ...
  IC: {
    summary:
      'displays an <b>influential and conscientious style (Ic)</b>. They balance creativity with precision, bringing innovative ideas while ensuring quality execution.',
    strengths: [
      'Creative problem-solving',
      'Quality awareness',
  ...
  SC: {
    summary:
      'displays a <b>steady and conscientious style (Sc)</b>. They combine reliability with attention to detail, excelling in roles requiring consistency and precision.',
    strengths: [
      'Reliable execution',
      'Quality focus',
      'Process improvement',
...
export const ADJACENCY_TYPES = {
  DIRECT: {
    ...
    description:
      'Current role directly prepares for target role. Minimal transition required.',
    color: '#e6ffe6',
  },
  NEAR: {
    label: 'Near Adjacency',
    description:
      'Strong overlap with target role requirements. Moderate transition effort needed.',
    color: '#e6f7ff',
  },
  MODERATE: {
    label: 'Moderate Adjacency',
    description:
      'Some transferable skills exist. Significant development required.',
    color: '#fff5e6',
  },
  FAR: {
    label: 'Far Adjacency',
    description:
      'Limited overlap with target role. Major transition and development needed.',
    color: '#ffe6e6',
  },
};
...
export const INDUSTRY_SUITABILITY_TEMPLATE = {
  ...
  MODERATE:
    'Transferable skills and foundational knowledge present. Can adapt with industry-specific training.',
