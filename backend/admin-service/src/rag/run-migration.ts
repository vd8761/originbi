...
async function runMigration() {
    ...
    try {
        ...
        const migrationPath = path.resolve(process.cwd(), '../database/migrations/001_rag_pgvector.sql');
        ...
        if (!fs.existsSync(migrationPath)) {
            ...
            const altPath = 'c:/Users/Jaya Krishna/Desktop/OriginBi/originbi/database/migrations/001_rag_pgvector.sql';
        ...
        `);
        console.log('Created RAG tables:', tables.rows.map(r => r.table_name));
