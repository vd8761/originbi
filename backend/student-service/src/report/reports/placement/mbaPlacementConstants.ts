...
export const MBA_PLACEMENT_CONTENT = {
  ...
  elective_rank_intro:
    'All five MBA specializations ranked by fit for this character, strongest first. The more filled dots (and the lower the rank number), the stronger the fit - the top, highlighted row is the best fit.',
