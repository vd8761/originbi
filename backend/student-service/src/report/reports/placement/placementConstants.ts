...
export const PLACEMENT_CONTENT = {
  ...
  disclaimer: {
    title: '3. Disclaimer',
    text1:
      '<p>This handbook is intended for internal use by placement officers, training and placement cells, and authorized academic staff. The assessments and career recommendations are generated using predictive models and AI-based tools. While every effort has been made to ensure accuracy and relevance, final decisions regarding placement should consider individual circumstances, market trends, and employer expectations.</p>',
    text2:
      '<p>The information provided in this document is confidential and proprietary to Origin BI. Unauthorized reproduction, distribution, or sharing of any part of this handbook is strictly prohibited.</p>',
  },
  ...
  contact: {
    ...
    intro:
      'For partnerships, training sessions, or access to individual student reports, please contact:',
