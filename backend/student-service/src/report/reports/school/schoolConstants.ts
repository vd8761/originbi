...
export const AICE: GCSESubject[] = [
  {
    "name": "Biology",
    "group": "Group 1: Mathematics and Sciences",
    "subject_code": "9700",
    "new": false,
    "analytical": 0.7,
    "numerical": 0.6,
  ...
  {
    "name": "Language & Literature in English",
    "group": "Group 2: Languages",
    "subject_code": "8695",
    "new": false,
    "analytical": 0.55,
  ...
  {
    "name": "Accounting",
    "group": "Group 3: Arts and Humanities",
    "subject_code": "9706",
    "new": false,
    "analytical": 0.5,
    "numerical": 0.7,
  ...
  },
  {
    ...
    "group": "Group 4: Interdisciplinary Subjects",
    "subject_code": "8021",
    "new": false,
    "analytical": 0.6,
    "numerical": 0.3,
...
export const GCSE: GCSESubject[] = [
  {
    "name": "Accounting",
    "group": "Creative and professional",
    "subject_code": "9706",
    "new": false,
    "analytical": 0.6,
    "numerical": 0.8,
  ...
  {
    "name": "Sport & Physical Education (AS Level only)",
    "group": "Creative and professional",
    "subject_code": "8386",
    "new": true,
    "analytical": 0.5,
  ...
  },
  {
    ...
    "group": "English language and literature",
    "subject_code": "8695",
    "new": false,
    "analytical": 0.55,
    "numerical": 0.25,
...
export const GCSE_PATHWAY_CONTENT = {
  ...
  as_desc: 'There are no compulsory subjects. You have the freedom to pick any combination of the 50+ available subjects. For example, if you only want to study sciences (Physics, Chemistry, and Biology), you can do so. This pathway is ideal if you already know the field you want to specialise in.',
  as_structure: 'Choose any 3-4 subjects from the full catalogue within any group.',

  diploma_title: 'AICE Diploma',
  diploma_desc: 'You are restricted by a group system. You cannot just pick any 3 subjects; you must select at least one from three different curriculum groups to ensure a broad education. Plus, Global Perspectives & Research (9239) is compulsory.',
  diploma_structure: 'Choose subjects from at least 3 of the 4 groups + Global Perspectives & Research.',

  // Section 3: AS & A Level Recommendations
  as_rec_title: 'International AS & A-Levels',
  as_rec_intro: 'Based on your behavioural profile, these are the subjects that align most naturally with your strengths. You can pick any 3 from this list - or from the full catalogue below.',
  as_rec_note: 'While there are no restrictions on how many subjects you can take, most universities expect 3 to 4 A-Level subjects. Taking 5 is rare and only recommended if you can maintain a manageable workload. We recommend choosing 3 or 4 subjects that genuinely interest you and align with your university goals.',
  as_others_title: 'Other Available Subjects',

  // Section 4: AICE Diploma Recommendations
  aice_rec_title: 'AICE Diploma',
  aice_rec_intro: 'The AICE Diploma requires at least one subject from three different groups. Below, we suggest the top subjects for you within each group. Pick the ones that excite you most.',
  aice_group_pick: 'Our top picks for you in this group:',
  aice_group_others: 'Also available in this group:',

  // Languages Group (AICE Group 2 - no DISC scoring)
  languages_group_name: 'Group 2: Languages',
  languages_note_title: 'A Note About Languages',
  languages_note: 'Language proficiency is deeply personal and cannot be meaningfully assessed through a behavioural profile. Your choice of language subject should be guided by your own fluency, cultural background, and future goals - whether that is strengthening a mother tongue, preparing for study abroad, or developing a competitive edge in the global job market. We encourage you to explore the languages available and choose one that resonates with your aspirations.',
  languages_subjects_intro: 'The following language subjects are available under this group:',

  // Section 5: Academic Journey
  journey_intro_template: 'Based on your unique profile, here is how your academic journey can unfold. Your strongest alignment is with $topSubject ($topScore% match) in the $topGroup group. You have multiple pathway options ahead - this roadmap helps you navigate them.',
};
