...
export const GCSE_PATHWAY_CONTENT = {
  ...
  pathways_intro:
    'After completing your IGCSEs, you have two routes to university-level qualifications. Both are internationally recognised and lead to the same universities - the difference is how you structure your subject choices.',

  as_title: 'International AS & A-Levels',
  as_desc:
    'There are no compulsory subjects. You have the freedom to pick any combination of the 50+ available subjects. For example, if you only want to study sciences (Physics, Chemistry, and Biology), you can do so. This pathway is ideal if you already know the field you want to specialise in.',
  as_structure:
    'Choose any 3-4 subjects from the full catalogue within any group.',

  diploma_title: 'AICE Diploma',
  diploma_desc:
    'You are restricted by a group system. You cannot just pick any 3 subjects; you must select at least one from three different curriculum groups to ensure a broad education. Plus, Global Perspectives & Research (9239) is compulsory.',
  diploma_structure:
    'Choose subjects from at least 3 of the 4 groups + Global Perspectives & Research.',

  // Section 3: AS & A Level Recommendations
  as_rec_title: 'International AS & A-Levels',
  as_rec_intro:
    'Based on your behavioural profile, these are the subjects that align most naturally with your strengths. You can pick any 3 from this list - or from the full catalogue below.',
  as_rec_note:
    'While there are no restrictions on how many subjects you can take, most universities expect 3 to 4 A-Level subjects. Taking 5 is rare and only recommended if you can maintain a manageable workload. We recommend choosing 3 or 4 subjects that genuinely interest you and align with your university goals.',
  as_others_title: 'Other Available Subjects',

  // Section 4: AICE Diploma Recommendations
  aice_rec_title: 'AICE Diploma',
  aice_rec_intro:
    'The AICE Diploma requires at least one subject from three different groups. Below, we suggest the top subjects for you within each group. Pick the ones that excite you most.',
  ...
  languages_note:
    'Language proficiency is deeply personal and cannot be meaningfully assessed through a behavioural profile. Your choice of language subject should be guided by your own fluency, cultural background, and future goals - whether that is strengthening a mother tongue, preparing for study abroad, or developing a competitive edge in the global job market. We encourage you to explore the languages available and choose one that resonates with your aspirations.',
  languages_subjects_intro:
    'The following language subjects are available under this group:',

  // Section 5: Academic Journey
  journey_intro_template:
    'Based on your unique profile, here is how your academic journey can unfold. Your strongest alignment is with $topSubject ($topScore% match) in the $topGroup group. You have multiple pathway options ahead - this roadmap helps you navigate them.',
};
