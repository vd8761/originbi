...
export const ACI: Record<string, any> = {
  ...
  ID: {
    ...
    agile_wise_breakdown: {
      ...
      openness: {
        behavioural_note: 'Welcomes feedback and loves exploring new ideas.',
        behavioural_description:
      ...
      courage: {
        behavioural_note: 'Expressive and bold, thrives in open discussion.',
        behavioural_description:
  ...
  IS: {
    ...
    agile_wise_breakdown: {
      ...
      respect: {
        behavioural_note: 'Deeply respectful and emotionally intelligent.',
        behavioural_description:
      ...
      courage: {
        behavioural_note: 'Learns to express disagreement more directly.',
        behavioural_description: 'You avoid confrontation to keep peace.',
        suggested_micro_habit:
  ...
  IC: {
    ...
    agile_wise_breakdown: {
      commitment: {
        ...
        behavioural_description: 'You love ideation more than execution.',
        suggested_micro_habit:
          'End each day by finishing one open loop - no creative drift.',
      },
      focus: {
        behavioural_note: 'Deeply analytical; maintains sustained attention.',
        behavioural_description: 'You work best in calm, structured settings.',
        suggested_micro_habit: 'Schedule one “no-meeting” focus block daily.',
      },
      openness: {
        behavioural_note: 'Curious and receptive to diverse input.',
        behavioural_description: 'You appreciate fresh inputs and new data.',
        suggested_micro_habit: 'Ask one person weekly to challenge your ideas.',
      },
      respect: {
        behavioural_note:
          'Courteous communicator; sometimes prefers independence.',
        behavioural_description: 'You’re courteous but private.',
        suggested_micro_habit: 'Ask for opinions early to build inclusivity.',
      },
      courage: {
        behavioural_note: 'Ready to take initiative with creative risk.',
  ...
  SD: {
    ...
    agile_wise_breakdown: {
      ...
      focus: {
        behavioural_note: 'Maintains attention and order in all tasks. ',
      ...
      respect: {
        ...
        behavioural_description: 'You treat people with sincerity and warmth. ',
        suggested_micro_habit:
          'Appreciate one teammate’s hidden effort each week. ',
      },
      courage: {
        behavioural_note: 'Hesitant to take risks or voice opinions first. ',
  ...
  SI: {
    ...
    agile_wise_breakdown: {
      commitment: {
        ...
        suggested_micro_habit: 'Before day ends, close at least one open loop.',
      },
      focus: {
        behavioural_note:
        ...
        suggested_micro_habit: 'Block two 25-minute silent sprints daily.',
      },
      openness: {
      ...
      courage: {
        behavioural_note: 'Learning to express opinions with confidence.',
        behavioural_description: 'You prefer agreement to confrontation.',
        suggested_micro_habit:
  ...
  SC: {
    ...
    agile_wise_breakdown: {
      commitment: {
        behavioural_note: 'Reliable and consistent; delivers on promises.',
        behavioural_description:
      ...
      focus: {
        behavioural_note: 'Calm under workload; maintains steady attention.',
      ...
      openness: {
        behavioural_note: 'Gradually accepts change; learning to adapt faster.',
  ...
  CD: {
    ...
    agile_wise_breakdown: {
      ...
      focus: {
        behavioural_note: 'Exceptionally attentive to detail and priority.',
        behavioural_description:
      ...
      openness: {
        behavioural_note: 'Learning to adapt and welcome diverse approaches.',
        behavioural_description: 'You tend to value facts over feelings.',
        suggested_micro_habit:
          'Ask a peer for one creative idea each week and try it without judging outcome.',
      },
      respect: {
        behavioural_note: 'Professional tone with scope to show empathy.',
        behavioural_description:
      ...
      courage: {
        behavioural_note: 'Honest and principled; leads through integrity.',
  ...
  CI: {
    ...
    agile_wise_breakdown: {
      ...
      focus: {
        behavioural_note: 'Exceptional concentration; stays deeply engaged.',
      ...
      openness: {
        ...
        behavioural_description: 'You value stability over spontaneity.',
        suggested_micro_habit: 'Try one suggestion outside your norm weekly.',
      },
      respect: {
        behavioural_note: 'Direct and logical; learning softer communication.',
        behavioural_description:
          'You communicate with clarity but can sound firm.',
        suggested_micro_habit: 'Add one empathetic phrase before critique.',
      },
      courage: {
        behavioural_note: 'Assertive in ethical or logical conflicts.',
        behavioural_description: 'You lead with ethics and truth.',
        suggested_micro_habit: 'Share a new improvement idea openly each week.',
      },
    },
    reflection_summary:
  ...
  CS: {
    ...
    agile_wise_breakdown: {
      commitment: {
        behavioural_note: 'Reliable and steady in fulfilling obligations.',
        behavioural_description: 'You stay true to deadlines and values.',
        suggested_micro_habit:
          'Take one new responsibility every week to stretch beyond comfort.',
      },
      focus: {
        behavioural_note: 'Maintains deep attention with minimal distractions.',
        behavioural_description:
      ...
      respect: {
        behavioural_note: 'Patient communicator; values people and harmony.',
        behavioural_description: 'You maintain warmth and patience.',
        suggested_micro_habit:
          'Ask one colleague each week what support they need from you.',
      },
      courage: {
        behavioural_note: 'Needs to express views with more assertiveness.',
