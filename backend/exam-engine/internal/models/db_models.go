...
type AssessmentQuestionOption struct {
	ID           int64     `gorm:"primaryKey;autoIncrement;column:qus_option_ID" json:"id"`
	...
	DiscFactor   *string   `gorm:"column:trait_text_en;type:text" json:"disc_factor"`
	ScoreValue   float64   `gorm:"column:trait_type;type:numeric(5,2);default:0" json:"score_value"`
	IsCorrect    bool      `gorm:"column:status;default:false" json:"is_correct"`
	Metadata     string    `gorm:"type:jsonb;default:'{}'" json:"metadata"`
	IsActive     bool      `gorm:"column:status;default:true" json:"is_active"`
	IsDeleted    bool      `gorm:"column:deleted;default:false" json:"is_deleted"`
...
type OpenQuestionOption struct {
	ID              int64     `gorm:"primaryKey;autoIncrement;column:open_question_option_ID" json:"id"`
	OpenQuestionID  int64     `gorm:"not null;column:open_question_ID" json:"open_question_id"`
	OptionType      int       `gorm:"not null;column:option_type" json:"option_type"`
	OptionTextEn    string    `gorm:"column:option_text_en;type:text" json:"option_text_en"`
	OptionTextTa    *string   `gorm:"column:option_text_ta;type:text" json:"option_text_ta"`
	OptionImageFile string    `gorm:"column:option_image_file;type:varchar(255)" json:"option_image_file"`
	TraitType       int       `gorm:"column:trait_type;type:smallint;default:0" json:"trait_type"`
	CreatedBy       int       `gorm:"column:createdby;type:integer;default:0" json:"created_by"`
	CreatedAt       time.Time `gorm:"column:created_at;default:now()" json:"created_at"`
	UpdatedAt       time.Time `gorm:"column:updated_at;default:now()" json:"updated_at"`
	Status          int       `gorm:"column:status;type:smallint;default:0" json:"status"`
	Deleted         int       `gorm:"column:deleted;type:smallint;default:0" json:"deleted"`

	// Compatibility fields (keep these for logic if needed, but not mapped to DB columns)
	IsValid      bool `gorm:"-" json:"is_valid"`
	DisplayOrder int  `gorm:"-" json:"display_order"`
	IsActive     bool `gorm:"-" json:"is_active"`
	IsDeleted    bool `gorm:"-" json:"is_deleted"`
