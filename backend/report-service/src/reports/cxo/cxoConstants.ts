export const CXO_TOC_CONTENT = [
    "About the Origin BI Self-Discovery Report",
    "Benefits of Identifying Strategic Business Enhancement Paths",
    "Personalized Leadership Insights for $full_name",
    "Your Key Strengths – How You Drive Impact",
    "What Drives You – Motivations and Needs for Strategic Growth",
    "Agile Compatibility Index (ACI)",
    "Your Executive Behavioral Snapshot",
    "Aligning Your Leadership Strengths with Future Business Vision",
    "Disclaimer",
];

export const CXO_CONTENT = {
    about_report: `The <b>Origin BI Self Discovery Report </b> is designed to provide deep insights into an individual’s behavioral tendencies, strengths, motivations, and areas for growth. By understanding these unique traits through the lens of the DISC framework (Dominance, Influence, Steadiness, and Conscientiousness), this self-discovery journey empowers individuals to make informed decisions about their personal and professional lives.`,
    ...
    purpose_items: [
        ...
        "To align your goals with inherent strengths and behavioral traits.",
    ...
    why_matters_items: [
        ...
        "Leverage their unique traits to excel in chosen your paths.",
    ],

    what_you_gain: [
        "An executive-level analysis of your leadership profile.",
        "Personalized strategies to enhance organizational growth and leadership impact.",
        "Strategic recommendations aligned with your core strengths.",
        "Insights to elevate team performance, drive business outcomes, and maximize influence.",
    ],
    ...
    benefits_identifying_strategic_business_paths: `Identifying the right strategic business enhancement paths is a pivotal step for visionary leaders seeking to drive sustainable growth and organizational excellence. In a rapidly evolving business landscape, aligning your leadership approach with core strengths and values enables more effective decision-making and impactful transformation. The <b>Origin BI Self-Discovery Report </b> provides you with deep insights to lead with clarity, confidence, and strategic foresight.`,

    benefits_identifying_strategic_business_paths_para_2: `Aligning your leadership approach with your unique strengths is not merely about steering the business - it’s about creating an environment where innovation, growth, and strategic vision can flourish. By understanding and leveraging your natural leadership traits, you position yourself to drive meaningful transformation, empower your teams, and deliver lasting value in an ever-evolving business landscape.`,

    why_identifying_right_strategic_path: `Aligning your leadership direction with your core strengths and authentic style leads to greater effectiveness and a stronger sense of purpose. Leveraging your natural abilities enables you to drive organizational performance, inspire your teams, and shape a vision for lasting success. Beyond individual achievement, a deep understanding of your leadership tendencies fosters high-impact collaboration, agile decision-making, and resilience-key traits for thriving in today's dynamic and complex business environment.`,

    why_identifying_right_strategic_path_para_2: `Moreover, identifying the right strategic direction enables ongoing leadership development and organizational growth. By gaining deeper insight into your key drivers and leadership style, you can proactively pursue opportunities that challenge your perspective, foster innovation, and elevate your impact-ensuring lasting fulfillment and continued success in your leadership journey.`,

    how_this_report_helps_you: `This self-discovery journey offers a personalized analysis of your behavioral tendencies, motivators, and areas of improvement. It provides clarity on:`,

    how_this_report_helps_list: [
        "The leadership roles and organizational settings where you can create the greatest impact.",
        "The primary drivers behind your leadership effectiveness and fulfillment.",
        "Strategic recommendations to align your approach with your core strengths and vision.",
    ],

    how_this_report_helps_you_para_2: `The insights gained from this report serve as a strategic guide to help you identify leadership opportunities and organizational paths that align with your strengths. Whether you are shaping your current leadership approach or preparing for new challenges ahead, this report equips you with the clarity and confidence to drive impactful decisions and inspire progress.`,

    important_note: `This report is not intended as a final prescription for your leadership journey, but rather as a thoughtful starting point. It highlights possibilities and strategic directions without limiting your options, reminding you that every organization faces a landscape full of evolving opportunities. While the recommendations are tailored to your unique strengths, your path forward will ultimately be defined by your vision, experiences, and ambitions. Consider this report a catalyst for further growth and exploration as you lead with confidence into the future.`,

    nature_style_intro: `<p>This chart visualizes your scores across the four DISC dimensions-Dominance, Influence, Steadiness, and Conscientiousness. It provides a snapshot of your natural behavioral style, highlighting your primary traits and how they balance with one another.</p>`,

    word_sketch_title: "My Natural Style – Word Sketch",
    word_sketch_desc:
        "This chart highlights the descriptors that most closely align with your natural behavioral style.",
    word_sketch_instructions:
        "Review the highlighted words to see how they describe your approach to leadership and interaction.",
...
export const DISCLAIMER_CONTENT = {
    title: "Disclaimer",
    intro: `The Origin BI Self-Discovery Report is designed as a personalized insights tool to help you understand your unique leadership style and behavioral characteristics. It serves as a guide for self-reflection and strategic growth within your organization. Please note that the traits and characteristics identified in this report are based on your responses and may evolve over time as your roles and circumstances change. This report is not definitive and should not be considered a substitute for professional or legal advice.`,
    limitations_title: "Limitations of the Self-Discovery Report:",
    limitations_bullets: [
        "This report offers an indicative understanding of your leadership and behavioral tendencies. It is not an absolute or unchanging representation of your capabilities or potential.",
        "The results should be seen as a catalyst for ongoing professional development and strategic growth, rather than a definitive judgment on your future performance.",
        "Strategic decisions-especially at the organizational level-should always be supported by further analysis, consultation, and broader perspectives beyond the scope of this self-discovery report.",
    ],
    no_warranties_title: "No Warranties or Liabilities:",
    no_warranties_intro:
        "1. Origin BI makes no warranties, express or implied, regarding the accuracy, adequacy, interpretation, or usefulness of the Origin BI Self Discovery Report.",
    no_warranties_disclaimer:
        "2. The use of this self-discovery journey is at your own discretion, and Origin BI shall not be held liable for:",
    no_warranties_bullets: [
        "Your use or application of the self-discovery results.",
        "The adequacy, accuracy, or interpretation of the information provided.",
        "Any decisions made or actions taken based on the self-discovery report.",
    ],
    indemnity_title: "Indemnity:",
    indemnity_intro: `By using this self-discovery report, you agree to waive any claims or rights of recourse against Origin BI. You also agree to indemnify and hold Origin BI harmless from any claims, liabilities, demands, or suits brought by third parties arising from:`,
    indemnity_bullets: [
        "Your use or application of the self-discovery report.",
    ...
    no_liability_desc: `Origin BI shall not be held responsible for any indirect, incidental, consequential, or punitive damages, including but not limited to loss of profits or claims made by third parties, even if advised of the possibility of such damages.`,
    closing_note: `This report is intended solely as a tool to provide insight and foster self-awareness. While it can inform your leadership approach, decisions should be made with a comprehensive understanding of all relevant factors. Please consider this as one of many resources supporting your ongoing journey of strategic growth and executive development.`,
};

export const CXO_DYNAMIC_CONTENT: Record<string, any> = {
    D: {
    ...
    <p>Your <b style="font-family:inter_18ptsemib;">Adapted Style </b> shows that you rely more on behaviors aligned with assertiveness and decision-making, traits typical of a <b style="font-family:inter_18ptsemib;">D </b> style, in your current focus area (work, social, or family). Your <b style="font-family:inter_18ptsemib;">Natural Style </b> graph indicates that you naturally tend to approach situations with confidence, a results-oriented mindset, and a drive to take charge.</p>`,
        ...
        <p>You are comfortable taking calculated risks to move forward, and your willingness to take bold steps often inspires confidence in others. While this trait is essential for driving innovation and progress, be mindful of balancing risk-taking with careful evaluation to avoid unnecessary pitfalls. Your decisiveness is an asset, but occasionally pausing to consider alternate approaches or gather more information can enhance your outcomes.</p>`,
        ...
        motivations_1: `<p>$full_name is a decisive, results-driven individual with a natural ability to lead and inspire action. Your energy comes from achieving goals, overcoming challenges, and driving success in everything you do. You excel in environments where you can take charge, create structure, and see measurable results from your efforts. People admire your ability to focus on the big picture, make bold decisions, and push through obstacles with determination and clarity.</p>`, // Use replace for full_name
        what_drives: "What Drives $full_name",
        motivations_desc_1: `<p>At your core, you are motivated by challenges and opportunities to demonstrate your capabilities. Whether it’s tackling a tough project or leading a team through adversity, you thrive when you are in control and can actively contribute to achieving meaningful outcomes. Success and recognition for your accomplishments keep you energized and focused.</p>
    ...
    <p>Your <b style="font-family:inter_18ptsemib;">Adapted Style </b> highlights that you tend to adopt behaviors typical of an <b style="font-family:inter_18ptsemib;">I </b> style, focusing on enthusiasm, communication, and relationship-building in your current focus. Your <b style="font-family:inter_18ptsemib;">Natural Style </b> graph suggests that you instinctively rely on sociability, creativity, and an optimistic approach to situations.</p>`,
        ...
        understanding_yourself_who_i_am_2: `<p>You are generally easy to get along with, showing genuine interest in others and approaching situations with optimism and patience. This makes you a natural fit for team environments, where your collaborative spirit and positive attitude are valued. Your ability to create a pleasant and productive atmosphere often makes you a go-to person for group projects or committee work. You consistently ensure tasks are completed effectively while fostering an enjoyable experience for everyone involved.</p>`,

        key_strengths_1: `<p>You consistently demonstrate strength in building relationships, inspiring others, and fostering collaboration within your organization. These qualities enable you to thrive in team settings and contribute positively to organizational goals. Your natural tendencies and work style preferences provide valuable insights into how you operate and excel in your professional and personal endeavors.</p>`,
        key_strengths_2: [
        ...
        motivations_1: `<p>You are a vibrant and people-oriented individual who thrives on connections, recognition, and opportunities to express yourself. You have an innate ability to bring energy to any environment, making you a natural motivator and influencer. Your enthusiasm is contagious, and it’s clear that you find joy in inspiring others, sharing ideas, and making a meaningful impact in both personal and professional spaces.</p>`,
        what_drives: "What Drives $full_name",
        motivations_desc_1: `<p>At your core, you are motivated by the opportunity to shine and be recognized for your contributions. Whether it’s receiving praise for your creative ideas or being acknowledged for your efforts, these moments validate your hard work and keep you energized. Your ability to engage with others and create strong interpersonal bonds is one of your standout qualities. You find fulfillment in being part of dynamic teams or communities where you can make meaningful connections.</p>
        ...
        growth_areas: `
        <p>Your vibrant personality and optimistic outlook are among your greatest assets, but like any strength, they can become challenges if not balanced. To ensure you continue to grow, here are some tailored recommendations for you:</p>
        <ol>
    ...
    <p>Your <b style="font-family:inter_18ptsemib;">Adapted Style </b> suggests that you focus on behaviors that align with the <b style="font-family:inter_18ptsemib;">S </b> style-showing patience, reliability, and supportiveness in your selected focus area. Your <b style="font-family:inter_18ptsemib;">Natural Style </b> graph indicates that you are naturally inclined toward creating harmony and maintaining stability in relationships and tasks.</p>`,
        ...
        key_strengths_1: `<p>You bring a calming and stabilizing presence to your organization, excelling in teamwork and collaboration. Your ability to build trust and maintain harmony helps create a positive and productive work environment. Your consistent and dependable work style ensures that tasks are completed with care and precision.</p>`,
        key_strengths_2: [
        ...
        unique_needs_desc_2: `<p>Your needs center around maintaining stability, predictability, and clarity. Environments with clear expectations and minimal surprises are where you thrive. While you are adaptable to change, you prefer transitions that are gradual and well-communicated. This helps you feel secure and prepared.</p>
    ...
    <p>Your <b style="font-family:inter_18ptsemib;">Adapted Style </b> shows that you emphasize behaviors aligned with the <b style="font-family:inter_18ptsemib;">C </b> style, focusing on precision, structure, and attention to detail in your current focus area. Your <b style="font-family:inter_18ptsemib;">Natural Style </b> graph highlights your instinctive preference for quality, accuracy, and logical decision-making.</p>`,
        ...
        motivations_1: `<p>You are a meticulous and detail-oriented individual who thrives on structure, precision, and quality. Your analytical mindset and commitment to excellence ensure that your contributions are thoughtful, reliable, and impactful. You find fulfillment in solving complex problems and creating systems that enhance efficiency and accuracy.</p>`,
        what_drives: "What Drives $full_name",
        motivations_desc_1: `<p>At your core, you are motivated by the desire to produce high-quality work and make well-informed decisions. Whether it’s analyzing data, improving processes, or ensuring accuracy, you take pride in your ability to create order and deliver results that meet or exceed expectations.</p>
        ...
        communication_desc_3: `<p>You appreciate communication that is clear, logical, and well-organized. Providing detailed explanations and justifications for decisions or changes helps you feel confident and engaged. Acknowledging your attention to detail and the value of your contributions builds trust and reinforces your motivation.</p>`,
        ...
        <ol>
            ...
            <li><b style="font-family:sorasemib;">Strengthening Collaboration </b>
                <p style="line-height:2px;">&nbsp;</p>
                <p style="font-family:inter_18pt; text-align:justify;">You may prefer to work independently, but seeking input from others can provide new perspectives and improve outcomes. Engaging with your team fosters a more inclusive and dynamic environment.</p>
            </li>
            <li><b style="font-family:sorasemib;">Managing Criticism </b>
                <p style="line-height:2px;">&nbsp;</p>
                <p style="font-family:inter_18pt; text-align:justify;">You may take criticism personally, viewing it as a flaw in your work. Viewing feedback as a tool for growth rather than a personal attack will help you build resilience and confidence.</p>
            </li>
            <li><b style="font-family:sorasemib;">Avoiding Overanalysis </b>
                <p style="line-height:2px;">&nbsp;</p>
                <p style="font-family:inter_18pt; text-align:justify;">Your desire for accuracy can sometimes lead to decision paralysis. Setting deadlines for analysis and trusting your judgment will ensure that you remain productive and decisive.</p>
            </li>
        </ol>`,
    },
};
    ...
    DI: {
        ...
        trait_combinations: [
            [
                ...
                "HR operations, compliance management, and repetitive processes.",
            ],
        ],
    },
    DS: {
        ...
        trait_combinations: [
            [
                ...
                "Project management, risk consulting, and high-stakes negotiations.",
            ],
        ],
    },
    DC: {
        ...
        trait_combinations: [
            [
                ...
                "Team coaching, creative campaigns, and handling interpersonal conflicts.",
            ],
        ],
    },
    ID: {
        ...
        trait_combinations: [
            [
                ...
                "Finance and accounting, technical support, and operational logistics.",
            ],
        ],
    },
    IS: {
        ...
        nature_suggestions:
            "Change Management Leader, Organizational Development Consultant, Executive Coach, Corporate Social Responsibility Strategist",
        key_behaviours: [
        ...
        trait_combinations: [
            [
                ...
                "Marketing campaigns, fast-paced product launches, and strategic consulting.",
            ],
        ],
    },
    IC: {
        ...
        trait_combinations: [
            [
                ...
                "HR conflict resolution, team coaching, and sales strategies with incomplete data.",
            ],
        ],
    },
    SD: {
        ...
        trait_combinations: [
            [
                ...
                "Growth strategy consulting, innovation planning, and deadline-driven marketing.",
            ],
        ],
    },
    SI: {
        ...
        trait_combinations: [
            [
                ...
                "Strategic planning, market research, and campaign execution.",
            ],
        ],
    },
    SC: {
        ...
        trait_combinations: [
            [
                ...
                "Brand strategy, creative team management, and high-speed operations.",
            ],
        ],
    },
    CD: {
        ...
        trait_combinations: [
            [
                ...
                "Customer support, branding, and conflict resolution.",
            ],
        ],
    },
    CI: {
        ...
        trait_combinations: [
            [
                ...
                "HR coaching, creative brainstorming, and flexible operational leadership.",
            ],
        ],
    },
    CS: {
        ...
        trait_combinations: [
            [
                ...
                "Strategic growth consulting, fast-paced marketing, and dynamic product development outsourcing.",
            ],
        ],
    },
};
