export const EMPLOYEE_TOC_CONTENT = [
    "About the Origin BI Self-Discovery Report",
    "Benefits of Identifying Suitable Career Enhancement Paths",
    ...
    "Mapping Your Strengths to Future Roles and Growth Opportunities",
    "Disclaimer",
];
...
export const DISCLAIMER_CONTENT = {
    ...
    closing_note: `This report is intended solely as a tool to provide insight and foster self-awareness. While it can support career guidance, decisions should be made with a comprehensive understanding of all influencing factors. Please consider this as one of many resources in your journey of self-discovery and professional development.`,
};

export const EMPLOYEE_DYNAMIC_CONTENT: Record<string, any> = {
    D: {
    ...
    C: {
        ...
        <p>Your <b style="font-family:inter_18ptsemib;">Adapted Style </b> highlights that you prioritize behaviors associated with the <b style="font-family:inter_18ptsemib;">C </b> style, such as accuracy, analysis, and adherence to high standards in your current focus area. Your <b style="font-family:inter_18ptsemib;">Natural Style </b> graph indicates that you instinctively value precision, order, and logical decision-making.</p>`,

        your_personalized_behavioral_understanding_the_graphs:
            "Understanding the Graphs:",
        your_personalized_behavioral_understanding_the_graphs_list: [
            `<b style="font-family:inter_18ptsemib;">Adapted Style (Graph I): </b> Reflects your focus on maintaining high standards and accuracy to meet the expectations of your environment. This may vary based on specific tasks or project requirements.<p style="line-height:4px;">&nbsp;</p>`,
            `<b style="font-family:inter_18ptsemib;">Natural Style (Graph II): </b> Represents your innate preference for structure, logic, and a systematic approach to problem-solving. These traits are most evident when you are working independently or in low-pressure situations.`,
        ],

        your_personalized_behavioral_key_insights: "Key Insights:",
        your_personalized_behavioral_key_insights_list: [
            `When both graphs are aligned, your environment supports your need for precision and order, allowing you to perform at your best.<p style="line-height:4px;">&nbsp;</p>`,
            `A significant divergence between the graphs may suggest you are adapting to meet conflicting demands, such as needing to make quick decisions without sufficient data.<p style="line-height:4px;">&nbsp;</p>`,
            `Ensure you have the time and resources needed to maintain quality while managing deadlines to reduce potential stress.`,
        ],
        ...
        <ol>
            <li><b style="font-family:sorasemib;">Balancing Perfection with Action </b>
                <p style="line-height:2px;">&nbsp;</p>
                <p style="font-family:inter_18pt; text-align:justify;">While striving for excellence is admirable, learning to accept “good enough” when necessary allows you to move projects forward without unnecessary delays.</p>
            </li>
            <li><b style="font-family:sorasemib;">Openness to Others' Ideas </b>
                <p style="line-height:2px;">&nbsp;</p>
                <p style="font-family:inter_18pt; text-align:justify;">Your reliance on logic may sometimes lead you to dismiss creative or emotional perspectives. Being open to diverse viewpoints can enhance collaboration and innovation.</p>
            </li>
            <li><b style="font-family:sorasemib;">Showing Appreciation </b>
                <p style="line-height:2px;">&nbsp;</p>
                <p style="font-family:inter_18pt; text-align:justify;">You may focus heavily on tasks and outcomes, inadvertently overlooking the need for positive reinforcement. Regularly acknowledging the efforts of others builds stronger relationships and morale.</p>
            </li>
            <li><b style="font-family:sorasemib;">Adapting to Change </b>
                <p style="line-height:2px;">&nbsp;</p>
                <p style="font-family:inter_18pt; text-align:justify;">Unexpected changes can be unsettling for you. Viewing change as an opportunity to improve processes rather than a disruption can help you adapt more easily.</p>
            </li>
            <li><b style="font-family:sorasemib;">Managing Stress </b>
                <p style="line-height:2px;">&nbsp;</p>
                <p style="font-family:inter_18pt; text-align:justify;">High pressure and chaotic environments can be draining. Developing strategies to manage stress and maintain focus during challenging times ensures sustained performance.</p>
            </li>
        </ol>`,
    },
};
...
export const BLENDED_STYLE_MAPPING: Record<string, any> = {
    ...
    IC: {
        ...
        style_desc: `<p><b style="font-family:inter_18ptsemib;">Description: </b> You are an innovative problem-solver who combines creativity with logic. Your ability to analyze details while seeing the bigger picture allows you to design unique and effective solutions.</p>`,
        nature_suggestions:
        ...
        key_behaviours: [
            ...
            "Thrives in environments that value both creativity and structure.",
            "Communicates complex ideas in an engaging and understandable way.",
            "Adapts quickly to new trends and technologies.",
            "Encourages brainstorming and out-of-the-box thinking.",
            "Maintains high standards of quality in all creative outputs.",
        ],
        typical_scenarios: [
    ...
    SD: {
        ...
        style_desc: `<p><b style="font-family:inter_18ptsemib;">Description: </b> You are a dependable and goal-oriented individual who excels at managing tasks and people with a steady hand. Your ability to drive results while maintaining stability makes you a trusted leader.</p>`,
        nature_suggestions:
            "Organizational Stabilizer, Risk Manager, Process Improvement Head, Resource Planner, Transformation Leader",
        key_behaviours: [
            "Balances a focus on results with a commitment to stability.",
            "Thrives in roles requiring consistency and long-term planning.",
            "Acts as a reliable point of contact for teams and stakeholders.",
            "Manages resources effectively to achieve organizational goals.",
            "Demonstrates resilience and patience in challenging situations.",
            "Encourages a culture of accountability and trust.",
            "Adapts to changes methodically to minimize disruption.",
            "Prioritizes quality and thoroughness in all endeavors.",
        ],
        typical_scenarios: [
    ...
    SI: {
        ...
        typical_scenarios: [
            "Organizing community outreach programs to build strong networks.",
            "Facilitating workshops to enhance team collaboration.",
            "Managing client relationships with a personal and empathetic touch.",
            "Leading initiatives to improve workplace culture and inclusivity.",
        ],
        trait_combinations: [
            [
