...
-- Source: C:\Users\Sriharan\Downloads\MBA Questions (4).xlsx [sheet: Survey Questions]
...
FROM oq, (VALUES
  ...
  (2, 'He is right and it matters. Welfare schemes create dependency. Real empowerment is economic opportunity, legal protection, and political representation - not free rides.', 'அவர் சொல்வது சரிதான், அது முக்கியமானது. நலத்திட்டங்கள் சார்புநிலையை உருவாக்குகின்றன. உண்மையான அதிகாரமளித்தல் என்பது இலவசப் பயணங்களல்ல; அது பொருளாதார வாய்ப்பு, சட்டப் பாதுகாப்பு மற்றும் அரசியல் பிரதிநிதித்துவம் ஆகும்.'),
...
SELECT oq.id, 'TEXT', v.en, v.ta, false, v.ord, true, false
FROM oq, (VALUES
  (1, 'I owe competence. The best thing I can do for society is build organisations that actually work - create real employment, pay real taxes, solve real problems. That is enough.', 'நான் திறமைக்குக் கடமைப்பட்டிருக்கிறேன். சமுதாயத்திற்கு நான் செய்யக்கூடிய மிகச் சிறந்த காரியம், உண்மையில் செயல்படும் அமைப்புகளைக் கட்டமைப்பதுதான் - உண்மையான வேலைவாய்ப்புகளை உருவாக்குவது, உண்மையான வரிகளைச் செலுத்துவது, உண்மையான பிரச்சனைகளைத் தீர்ப்பது. அதுவே போதுமானது.'),
...
FROM oq, (VALUES
  ...
  (3, 'The investor who mortgaged his house made a high-risk decision with his eyes open. Personal responsibility matters. The founder did not force him to invest.', 'தன் வீட்டை அடமானம் வைத்த முதலீட்டாளர், நன்கு அறிந்தே அதிக ஆபத்துள்ள முடிவை எடுத்தார். தனிப்பட்ட பொறுப்புணர்வு முக்கியமானது. நிறுவனர் அவரை முதலீடு செய்யக் கட்டாயப்படுத்தவில்லை.'),
...
FROM oq, (VALUES
  ...
  (4, 'It tells me that outcome measurement is not built into scheme design from the start. Every scheme needs a closure trigger - a condition under which it automatically sunsets - not just a launch press conference.', 'திட்ட வடிவமைப்பில் தொடக்கத்திலிருந்தே விளைவு அளவீடு உள்ளடக்கப்படவில்லை என்பதை இது எனக்கு உணர்த்துகிறது. ஒவ்வொரு திட்டத்திற்கும் ஒரு தொடக்கச் செய்தியாளர் சந்திப்பு மட்டுமல்ல, அத்திட்டம் தானாகவே காலாவதியாகும் ஒரு நிறைவுத் தூண்டுதல் தேவைப்படுகிறது.')
) AS v(ord, en, ta);
...
FROM oq, (VALUES
  ...
  (2, 'The wealth concentration figures are real but the stability argument is overstated for India specifically. India has managed extreme inequality for decades without the political ruptures that similar distributions produced elsewhere.', 'செல்வக் குவிப்புப் புள்ளிவிவரங்கள் உண்மையானவை, ஆனால் நிலைத்தன்மை குறித்த வாதம் குறிப்பாக இந்தியாவைப் பொறுத்தவரை மிகைப்படுத்தப்பட்டுள்ளது. மற்ற இடங்களில் இதே போன்ற பகிர்வுகள் உருவாக்கிய அரசியல் பிளவுகள் எதுவுமின்றி, இந்தியா பல தசாப்தங்களாகக் கடுமையான ஏற்றத்தாழ்வைச் சமாளித்து வந்துள்ளது.'),
...
SELECT oq.id, 'TEXT', v.en, v.ta, false, v.ord, true, false
FROM oq, (VALUES
  (1, 'Yes - learn everything he knows about building businesses and make your own ethical choices independently. His past does not contaminate his knowledge. Separate the lessons from the history.', 'ஆம் - வணிகங்களை உருவாக்குவது பற்றி அவருக்குத் தெரிந்த அனைத்தையும் கற்றுக்கொண்டு, உங்கள் சொந்த நெறிமுறை சார்ந்த தேர்வுகளைச் சுதந்திரமாக மேற்கொள்ளுங்கள். அவருடைய கடந்த காலம் அவருடைய அறிவைக் களங்கப்படுத்தாது. வரலாற்றிலிருந்து பாடங்களைப் பிரித்தறியுங்கள்.'),
...
WITH oq AS (
  INSERT INTO open_questions
    (question_type, media_type, set_number,
     ...
     metadata, is_active, is_deleted)
  VALUES ('SURVEY', 'TEXT', 4,
     'Verghese Kurien built Amul - the world''s largest dairy cooperative - by putting farmers in ownership of a supply chain that previously exploited them. He turned down multiple private sector opportunities to stay with the cooperative for 40 years.', 'A professor asks - what kind of leader does it take to build something that is not yours to own?', 'முன்னர் விவசாயிகளைச் சுரண்டி வந்த விநியோகச் சங்கிலியின் உரிமையாளர்களாக அவர்களை ஆக்குவதன் மூலம், வர்கீஸ் குரியன் உலகின் மிகப்பெரிய பால் கூட்டுறவு நிறுவனமான அமுலைக் கட்டியெழுப்பினார். அந்தக் கூட்டுறவு நிறுவனத்தில் 40 ஆண்டுகள் நீடிப்பதற்காக, அவர் தனியார் துறையிலிருந்து கிடைத்த பல வாய்ப்புகளை நிராகரித்தார்.', 'சொந்தம் கொண்டாட முடியாத ஒன்றை உருவாக்குவதற்கு எத்தகைய தலைவர் தேவை என்று ஒரு பேராசிரியர் கேட்கிறார்.',
     '{"theme": "Leadership Awareness", "source": "mba_survey_v1"}'::jsonb, true, false)
  RETURNING id
)
INSERT INTO open_question_options
...
FROM oq, (VALUES
  ...
  (2, 'Partially - constitutional amendments require consensus that takes time to build. The delimitation linkage may be genuine administrative necessity not political evasion. Assume bad faith only when the evidence demands it.', 'பகுதியளவு - அரசியலமைப்புத் திருத்தங்களுக்கு, உருவாகுவதற்கு நேரம் எடுக்கும் ஒருமித்த கருத்து தேவைப்படுகிறது. தொகுதி வரையறை இணைப்பு என்பது அரசியல் தந்திரமாக இல்லாமல், உண்மையான நிர்வாகத் தேவையாக இருக்கலாம். ஆதாரம் தேவைப்படும்போது மட்டுமே உள்நோக்கத்துடன் செயல்படுவதாகக் கருதவும்.'),
...
WITH oq AS (
  INSERT INTO open_questions
    (question_type, media_type, set_number,
     ...
     metadata, is_active, is_deleted)
  VALUES ('SURVEY', 'TEXT', 5,
     'India''s MGNREGA - the rural employment guarantee scheme - guarantees 100 days of paid work per year to rural households. It employs approximately 6–7 crore households annually at ₹200–300 per day. Economists disagree sharply - some call it India''s most successful poverty intervention, others call it a fiscal drain that crowds out productive investment. A professor asks - how do you evaluate a policy where both sides have credible evidence?', NULL, 'இந்தியாவின் மகாத்மா காந்தி தேசிய ஊரக வேலைவாய்ப்பு உறுதித் திட்டம் (MGNREGA), கிராமப்புறக் குடும்பங்களுக்கு ஆண்டுக்கு 100 நாட்கள் ஊதியத்துடன் கூடிய வேலைக்கு உத்தரவாதம் அளிக்கிறது. இது ஆண்டுதோறும் சுமார் 6-7 கோடி குடும்பங்களுக்கு ஒரு நாளைக்கு ₹200-300 என்ற ஊதியத்தில் வேலைவாய்ப்பை வழங்குகிறது. பொருளாதார வல்லுநர்கள் இதில் கடுமையாக முரண்படுகின்றனர் - சிலர் இதை இந்தியாவின் மிகவும் வெற்றிகரமான வறுமை ஒழிப்புத் திட்டம் என்று அழைக்கின்றனர், மற்றவர்களோ இது ஆக்கப்பூர்வமான முதலீடுகளை வெளியேற்றும் ஒரு நிதிச் சுமை என்கின்றனர். இரு தரப்பிலும் நம்பகமான சான்றுகள் இருக்கும் ஒரு கொள்கையை எப்படி மதிப்பிடுவது என்று ஒரு பேராசிரியர் கேட்கிறார்.', NULL,
     '{"theme": "Political Economy", "source": "mba_survey_v1"}'::jsonb, true, false)
  RETURNING id
)
INSERT INTO open_question_options
...
WITH oq AS (
  INSERT INTO open_questions
    (question_type, media_type, set_number,
     ...
     metadata, is_active, is_deleted)
  VALUES ('SURVEY', 'TEXT', 5,
     'Sam Pitroda - the architect of India''s telecom revolution in the 1980s - convinced Rajiv Gandhi to build the public telecom infrastructure that eventually enabled the mobile revolution and the IT industry. He was a non-resident Indian with no political base, no bureaucratic seniority, and no institutional authority. He succeeded because one political leader trusted him completely. A professor asks - what does Pitroda''s story tell us about how change happens in large systems?', NULL, '1980-களில் இந்தியாவின் தொலைத்தொடர்புப் புரட்சியின் சிற்பியான சாம் பிட்ரோடா, இறுதியில் அலைபேசிப் புரட்சிக்கும் தகவல் தொழில்நுட்பத் துறைக்கும் வழிவகுத்த பொதுத் தொலைத்தொடர்பு உள்கட்டமைப்பை உருவாக்குமாறு ராஜீவ் காந்தியைச் சம்மதிக்க வைத்தார். அவர் வெளிநாடு வாழ் இந்தியராக, எந்த அரசியல் அடித்தளமும், அதிகாரப் பதவி மூப்பும், நிறுவன அதிகாரமும் அற்றவராக இருந்தார். ஓர் அரசியல் தலைவர் அவரை முழுமையாக நம்பியதாலேயே அவர் வெற்றி பெற்றார். ஒரு பேராசிரியர் கேட்கிறார் - பெரிய அமைப்புகளில் மாற்றம் எவ்வாறு நிகழ்கிறது என்பதைப் பற்றி பிட்ரோடாவின் கதை நமக்கு என்ன சொல்கிறது?', NULL,
     '{"theme": "Leadership Awareness", "source": "mba_survey_v1"}'::jsonb, true, false)
  RETURNING id
)
INSERT INTO open_question_options
...
WITH oq AS (
  INSERT INTO open_questions
    (question_type, media_type, set_number,
     ...
     metadata, is_active, is_deleted)
  VALUES ('SURVEY', 'TEXT', 5,
     'You have just answered 99 questions about India - its governance, its economy, its society, its leaders, and its future. A professor asks one final question: "After everything you have studied, everything you have seen, and everything you are about to go and do - are you optimistic about India?"', NULL, 'நீங்கள் இப்போதுதான் இந்தியாவைப் பற்றிய 99 கேள்விகளுக்குப் பதிலளித்திருக்கிறீர்கள் - அதன் ஆட்சிமுறை, பொருளாதாரம், சமூகம், தலைவர்கள் மற்றும் அதன் எதிர்காலம் என அனைத்தும். ஒரு பேராசிரியர் இறுதியாக ஒரு கேள்வியைக் கேட்கிறார்: "நீங்கள் படித்த அனைத்திற்கும், நீங்கள் கண்ட அனைத்திற்கும், நீங்கள் செய்யப்போகும் அனைத்திற்கும் பிறகு - இந்தியாவைப் பற்றி நீங்கள் நம்பிக்கையுடன் இருக்கிறீர்களா?"', NULL,
     '{"theme": "The MBA & Society", "source": "mba_survey_v1"}'::jsonb, true, false)
  RETURNING id
)
INSERT INTO open_question_options
