...
-- Source: C:\Users\Sriharan\Downloads\MBA Questions (6).xlsx
...
FROM q, (VALUES
  (1, 'Drop the club meeting without overthinking it - the submission is what matters and I will chase the next opportunity when it comes.', 'அதிகமாக யோசிக்காமல் மன்றக் கூட்டத்தை விட்டுவிடுங்கள் - சமர்ப்பிப்பதுதான் முக்கியம், அடுத்த வாய்ப்பு வரும்போது அதைத் தேடிக்கொள்வேன்.', 'D', '{"dimension": "decision_speed"}'),
...
FROM q, (VALUES
  ...
  (3, 'Talk to the other three members first to understand how they are feeling before doing anything - I do not want to act in a way that fractures the group.', 'எதையும் செய்வதற்கு முன், மற்ற மூன்று உறுப்பினர்களிடம் முதலில் பேசி அவர்கள் எப்படி உணர்கிறார்கள் என்பதைத் தெரிந்துகொள்ளுங்கள் - நான் குழுவைப் பிளவுபடுத்தும் விதத்தில் செயல்பட விரும்பவில்லை.', 'S', '{"dimension": "conflict_response"}'),
...
SELECT q.id, v.ord, v.en, v.ta, v.fac, 1.0, v.meta::jsonb, true, false
FROM q, (VALUES
  (1, 'Identify the two or three firms I want most and go after them with everything - I am not going to dilute my effort across too many options.', 'எனக்கு மிகவும் விருப்பமான இரண்டு அல்லது மூன்று நிறுவனங்களை அடையாளம் கண்டு, என் முழு முயற்சியையும் கொண்டு அவற்றை அணுகுவேன் - என் முயற்சியை அதிகமான விருப்பங்களில் சிதறடிக்கப் போவதில்லை.', 'D', '{"dimension": "stability_need"}'),
...
FROM q, (VALUES
  ...
  (2, 'Find a low-pressure moment and create an opportunity for them to open up naturally - a direct question might close them further.', 'அழுத்தம் குறைந்த ஒரு தருணத்தைக் கண்டறிந்து, அவர்கள் இயல்பாக மனம் திறந்து பேச ஒரு வாய்ப்பை உருவாக்குங்கள் - ஒரு நேரடிக் கேள்வி அவர்களை மேலும் உள்முகமாகச் சிந்திக்க வைத்துவிடக்கூடும்.', 'I', '{"dimension": "stability_need"}'),
...
FROM q, (VALUES
  ...
  (2, 'The need to read the room and respond in a way that keeps you credible regardless of who wins the argument.', 'விவாதத்தில் யார் வெற்றி பெற்றாலும், சூழ்நிலையைப் புரிந்துகொண்டு, உங்கள் நம்பகத்தன்மையை நிலைநிறுத்தும் வகையில் பதிலளிக்க வேண்டிய அவசியம்.', 'I', '{"raw_factor": "I over D", "dimension": "approval_need vs accuracy_need"}'),
...
WITH q AS (
  ...
  VALUES ((SELECT id FROM assessment_levels WHERE level_number = 1), 2, (SELECT id FROM programs WHERE code = 'COLLEGE_STUDENT'),
     'You are bidding for electives and the window closes in two hours. Your carefully planned combination requires you to win three specific courses. A batchmate has just told you that one of your target electives is massively oversubscribed and you will almost certainly lose it. Changing your bid now means rethinking your entire second year plan under pressure.', 'Will you re-bid or risk?', 'நீங்கள் விருப்பப் பாடங்களுக்கு விண்ணப்பித்துள்ளீர்கள், அதற்கான காலக்கெடு இன்னும் இரண்டு மணி நேரத்தில் முடிவடைகிறது. நீங்கள் கவனமாகத் திட்டமிட்ட பாடங்களின் தொகுப்பிற்கு, மூன்று குறிப்பிட்ட பாடங்களில் வெற்றி பெற வேண்டும். உங்கள் இலக்கு விருப்பப் பாடங்களில் ஒன்றிற்கு மிக அதிக விண்ணப்பங்கள் வந்துவிட்டதாகவும், நீங்கள் அதை கிட்டத்தட்ட நிச்சயமாக இழந்துவிடுவீர்கள் என்றும் உங்கள் வகுப்புத் தோழர் ஒருவர் சற்று முன்பு உங்களிடம் கூறியுள்ளார். இப்போது உங்கள் விண்ணப்பத்தை மாற்றுவது என்பது, அழுத்தத்தின் கீழ் உங்கள் இரண்டாம் ஆண்டுக்கான முழுத் திட்டத்தையும் மறுபரிசீலனை செய்வதாகும்.', 'மீண்டும் ஏலம் கேட்பீர்களா அல்லது இடர் எடுப்பீர்களா?',
     '{"theme": "Academic Pressure & Performance", "dimension": "decision_speed", "layer": "1", "source": "mba_xlsx_v1"}'::jsonb, true, false)
  RETURNING id
)
INSERT INTO assessment_question_options
...
WITH q AS (
  INSERT INTO assessment_questions
    (assessment_level_id, set_number, program_id,
     ...
     metadata, is_active, is_deleted)
  VALUES ((SELECT id FROM assessment_levels WHERE level_number = 1), 2, (SELECT id FROM programs WHERE code = 'COLLEGE_STUDENT'),
     'The honest feeling underneath this: your peer evaluation scores have just come back. Three anonymous batchmates have rated your contribution to group work as below expectations. You have been one of the more present and vocal members of your group all term and genuinely believed you were carrying your share.', 'What is actually happening inside you before you say anything to anyone?', 'இதன் பின்னணியில் உள்ள உண்மையான உணர்வு இதுதான்: உங்கள் சக மதிப்பீட்டு மதிப்பெண்கள் இப்போதுதான் வந்துள்ளன. பெயர் குறிப்பிட விரும்பாத மூன்று வகுப்புத் தோழர்கள், குழுப் பணிகளில் உங்கள் பங்களிப்பு எதிர்பார்த்ததை விடக் குறைவாக இருப்பதாக மதிப்பிட்டுள்ளனர். பருவம் முழுவதும் உங்கள் குழுவில் மிகவும் சுறுசுறுப்பாகவும், தங்கள் கருத்துக்களை வெளிப்படையாகவும் தெரிவித்த உறுப்பினர்களில் ஒருவராக நீங்கள் இருந்தீர்கள்; மேலும், உங்கள் பங்கை நீங்கள் சரியாகச் செய்ததாக உண்மையாகவே நம்பினீர்கள்.', 'நீங்கள் யாரிடமும் எதையும் சொல்வதற்கு முன்பு, உங்களுக்குள் உண்மையில் என்ன நடந்துகொண்டிருக்கிறது?',
     '{"theme": "Academic Pressure & Performance", "dimension": "approval_need", "layer": "3", "source": "mba_xlsx_v1"}'::jsonb, true, false)
  RETURNING id
)
INSERT INTO assessment_question_options
...
FROM q, (VALUES
  ...
  (4, 'Review both versions yourself first to assess whether the rewrite actually improved the work before deciding how seriously to treat this.', 'இதை எவ்வளவு தீவிரமாக எடுத்துக்கொள்வது என்று தீர்மானிக்கும் முன், திருத்தம் உண்மையில் படைப்பை மேம்படுத்தியதா என்பதை மதிப்பிடுவதற்கு, முதலில் இரண்டு பதிப்புகளையும் நீங்களே மதிப்பாய்வு செய்யுங்கள்.', 'C', '{"dimension": "conflict_response"}')
) AS v(ord, en, ta, fac, meta);
...
WITH q AS (
  INSERT INTO assessment_questions
    (assessment_level_id, set_number, program_id,
     ...
     metadata, is_active, is_deleted)
  VALUES ((SELECT id FROM assessment_levels WHERE level_number = 1), 2, (SELECT id FROM programs WHERE code = 'COLLEGE_STUDENT'),
     'You are leading a cross-batch initiative with no formal budget. You have been trying to get the student affairs office to allocate a small fund for three weeks. They keep redirecting you. The initiative launches in ten days and you need a decision now.', 'How will you secure funding?', 'முறையான நிதி ஒதுக்கீடு இல்லாத, பல்வேறு குழுக்களை உள்ளடக்கிய ஒரு முன்னெடுப்பை நீங்கள் வழிநடத்துகிறீர்கள். கடந்த மூன்று வாரங்களாக, ஒரு சிறிய நிதியை ஒதுக்கீடு செய்யுமாறு மாணவர் நல அலுவலகத்திடம் நீங்கள் முயற்சி செய்து வருகிறீர்கள். ஆனால், அவர்கள் உங்களைத் தொடர்ந்து வேறு இடத்திற்கு அனுப்புகிறார்கள். இந்த முன்னெடுப்பு இன்னும் பத்து நாட்களில் தொடங்குகிறது, உங்களுக்கு இப்போதே ஒரு முடிவு தேவை.', 'நீங்கள் நிதியை எவ்வாறு திரட்டுவீர்கள்?',
     '{"theme": "Leadership & Authority", "dimension": "control_need", "layer": "1", "source": "mba_xlsx_v1"}'::jsonb, true, false)
  RETURNING id
)
INSERT INTO assessment_question_options
...
WITH q AS (
  INSERT INTO assessment_questions
    (assessment_level_id, set_number, program_id,
     ...
     metadata, is_active, is_deleted)
  VALUES ((SELECT id FROM assessment_levels WHERE level_number = 1), 2, (SELECT id FROM programs WHERE code = 'COLLEGE_STUDENT'),
     'You are representing your batch in a faculty grievance about a course that has been consistently poorly managed. The faculty panel has asked for your response in writing by end of day. You have not yet consulted the full batch on the specific wording. You have two hours.', 'Something went wrong. Try again.', 'தொடர்ந்து மோசமாக நிர்வகிக்கப்பட்டு வரும் ஒரு பாடநெறி குறித்த பேராசிரியர்களின் குறைதீர்ப்பில், நீங்கள் உங்கள் மாணவர் குழுவின் சார்பாகப் பங்கேற்கிறீர்கள். பேராசிரியர்கள் குழு, அன்றைய தினத்தின் முடிவுக்குள் உங்கள் பதிலை எழுத்துப்பூர்வமாக வழங்குமாறு கேட்டுள்ளது. குறிப்பிட்ட வார்த்தைகள் குறித்து நீங்கள் இன்னும் முழு மாணவர் குழுவிடமும் கலந்தாலோசிக்கவில்லை. உங்களுக்கு இரண்டு மணி நேரம் உள்ளது.', 'ஏதோ தவறு நடந்துவிட்டது. மீண்டும் முயற்சிக்கவும்.',
     '{"theme": "Leadership & Authority", "dimension": "decision_speed", "layer": "1", "source": "mba_xlsx_v1"}'::jsonb, true, false)
  RETURNING id
)
INSERT INTO assessment_question_options
...
FROM q, (VALUES
  ...
  (4, 'Submit today but frame the response carefully as preliminary, noting that a fuller batch consultation is underway - buy time without missing the deadline.', 'இன்றே சமர்ப்பிக்கவும், ஆனால் முழுமையான குழு கலந்தாய்வு நடைபெற்று வருவதைக் குறிப்பிட்டு, உங்கள் பதிலை ஒரு பூர்வாங்கப் பதில் என கவனமாக வடிவமைக்கவும் - இதன் மூலம் காலக்கெடுவைத் தவறவிடாமல் அவகாசம் பெறலாம்.', 'C', '{"dimension": "decision_speed"}')
) AS v(ord, en, ta, fac, meta);
...
WITH q AS (
  INSERT INTO assessment_questions
    (assessment_level_id, set_number, program_id,
     ...
     metadata, is_active, is_deleted)
  VALUES ((SELECT id FROM assessment_levels WHERE level_number = 1), 2, (SELECT id FROM programs WHERE code = 'COLLEGE_STUDENT'),
     'You are three months into your MBA. A headhunter has reached out with a full-time role at a firm you genuinely respect - senior to anything you could expect from campus placement and starting immediately after graduation. Taking it seriously means stepping back from the placement process your batch is fully engaged in. The offer has a two-week response window.', 'How will you proceed now?', 'நீங்கள் உங்கள் MBA படிப்பைத் தொடங்கி மூன்று மாதங்கள் ஆகின்றன. நீங்கள் உண்மையாகவே மதிக்கும் ஒரு நிறுவனத்தில், ஒரு வேலைவாய்ப்பு முகவர் உங்களைத் தொடர்புகொண்டுள்ளார். வளாகத் தேர்வில் நீங்கள் எதிர்பார்க்கக்கூடியதை விட உயர்வான பதவியாகவும், பட்டப்படிப்பு முடிந்த உடனேயே தொடங்கும் வகையிலும் இந்தப் பணி அமைந்துள்ளது. இதைத் தீவிரமாக எடுத்துக்கொள்வதென்றால், உங்கள் குழுவினர் முழுமையாக ஈடுபட்டுள்ள வேலைவாய்ப்புச் செயல்முறையிலிருந்து நீங்கள் சற்று விலகி நிற்க வேண்டும். இந்த வாய்ப்பு குறித்துப் பதிலளிக்க இரண்டு வார கால அவகாசம் உள்ளது.', 'இனி நீங்கள் எப்படிச் செயல்படுவீர்கள்?',
     '{"theme": "Career Decisions & Internships", "dimension": "change_tolerance", "layer": "1", "source": "mba_xlsx_v1"}'::jsonb, true, false)
  RETURNING id
)
INSERT INTO assessment_question_options
...
WITH q AS (
  INSERT INTO assessment_questions
    (assessment_level_id, set_number, program_id,
     ...
     metadata, is_active, is_deleted)
  VALUES ((SELECT id FROM assessment_levels WHERE level_number = 1), 2, (SELECT id FROM programs WHERE code = 'COLLEGE_STUDENT'),
     'A peer is spreading a version of something you said in a casual conversation that strips the context and makes you sound dismissive of a group of people you genuinely respect. It has reached four or five batchmates. Nobody has come to you directly but you can feel the temperature change in a few interactions this week.', 'How will you handle this?', 'நீங்கள் ஒரு சாதாரண உரையாடலில் சொன்ன ஒரு விஷயத்தை, அதன் சூழலைத் திரித்து, நீங்கள் உண்மையாகவே மதிக்கும் ஒரு குழுவினரை அலட்சியப்படுத்துவது போலக் காட்டும் ஒரு பதிப்பை உங்கள் சக மாணவர் ஒருவர் பரப்பி வருகிறார். இது நான்கு அல்லது ஐந்து வகுப்புத் தோழர்களைச் சென்றடைந்துள்ளது. யாரும் நேரடியாக உங்களிடம் வரவில்லை, ஆனால் இந்த வாரத்தில் நடந்த சில உரையாடல்களில் சூழ்நிலை மாறுவதை உங்களால் உணர முடிகிறது.', 'நீங்கள் இதை எப்படிச் சமாளிப்பீர்கள்?',
     '{"theme": "Peer Comparison & Competition", "dimension": "stability_need", "layer": "1", "source": "mba_xlsx_v1"}'::jsonb, true, false)
  RETURNING id
)
INSERT INTO assessment_question_options
...
WITH q AS (
  INSERT INTO assessment_questions
    (assessment_level_id, set_number, program_id,
     ...
     metadata, is_active, is_deleted)
  VALUES ((SELECT id FROM assessment_levels WHERE level_number = 1), 2, (SELECT id FROM programs WHERE code = 'COLLEGE_STUDENT'),
     'Your team is finalising a deliverable for a real client. Under deadline pressure, one team member has filled a data gap with a figure they have described as estimated but presented in the document as verified. The client will use this report to make a resourcing decision. Submission is in three hours.', 'How will you handle this?', 'உங்கள் குழு ஒரு உண்மையான வாடிக்கையாளருக்கான ஒப்படைப்பை இறுதி செய்து கொண்டிருக்கிறது. காலக்கெடுவின் நெருக்கடியில், ஒரு குழு உறுப்பினர், ஒரு தரவு இடைவெளியை நிரப்புவதற்காக, மதிப்பிடப்பட்டதாகக் குறிப்பிட்ட ஒரு எண்ணை ஆவணத்தில் சரிபார்த்ததாகக் காட்டியுள்ளார். வாடிக்கையாளர், பணியாளர் ஒதுக்கீடு குறித்த முடிவை எடுக்க இந்த அறிக்கையைப் பயன்படுத்துவார். சமர்ப்பிப்பதற்கான கடைசி நேரம் மூன்று மணி நேரம்.', 'நீங்கள் இதை எப்படிச் சமாளிப்பீர்கள்?',
     '{"theme": "Ethical Pressure", "dimension": "conflict_response", "layer": "1", "source": "mba_xlsx_v1"}'::jsonb, true, false)
  RETURNING id
)
INSERT INTO assessment_question_options
...
FROM q, (VALUES
  ...
  (2, 'The anxiety about how declining lands with the professor and whether it quietly affects how they see you for the rest of the term.', 'நமது மதிப்பெண் குறைவது பேராசிரியருக்கு எப்படிப் படும் என்பதும், அது மீதமுள்ள பருவத்தில் அவர் உங்களைப் பார்க்கும் விதத்தை மறைமுகமாகப் பாதிக்குமா என்பது பற்றிய கவலையும்.', 'I', '{"dimension": "conflict_response vs approval_need"}'),
...
WITH q AS (
  INSERT INTO assessment_questions
    (assessment_level_id, set_number, program_id,
     ...
     metadata, is_active, is_deleted)
  VALUES ((SELECT id FROM assessment_levels WHERE level_number = 1), 2, (SELECT id FROM programs WHERE code = 'COLLEGE_STUDENT'),
     'You are pitching a student initiative to a VC panel as part of a programme competition. One of the panellists - a well-known investor - is visibly unengaged from the first slide. They are checking their phone. The rest of the panel is attentive. You have eight minutes left.', 'How will you engage them?', 'ஒரு நிகழ்ச்சிப் போட்டியின் ஒரு பகுதியாக, நீங்கள் ஒரு மாணவர் முன்னெடுப்பு ஒன்றை துணிகர முதலீட்டாளர் குழுவிடம் முன்வைக்கிறீர்கள். குழு உறுப்பினர்களில் ஒருவரான, நன்கு அறியப்பட்ட முதலீட்டாளர், முதல் ஸ்லைடிலிருந்தே வெளிப்படையாக ஆர்வமின்றி இருக்கிறார். அவர் தனது கைப்பேசியைப் பார்த்துக் கொண்டிருக்கிறார். குழுவின் மற்ற உறுப்பினர்கள் கவனத்துடன் இருக்கிறார்கள். உங்களுக்கு இன்னும் எட்டு நிமிடங்கள் உள்ளன.', 'நீங்கள் அவர்களை எவ்வாறு ஈடுபடுத்துவீர்கள்?',
     '{"theme": "Communication & Influence", "dimension": "approval_need", "layer": "1", "source": "mba_xlsx_v1"}'::jsonb, true, false)
  RETURNING id
)
INSERT INTO assessment_question_options
...
WITH q AS (
  INSERT INTO assessment_questions
    (assessment_level_id, set_number, program_id,
     ...
     metadata, is_active, is_deleted)
  VALUES ((SELECT id FROM assessment_levels WHERE level_number = 1), 2, (SELECT id FROM programs WHERE code = 'COLLEGE_STUDENT'),
     'You are delivering a town hall update to your batch on a facilities issue that has been handled poorly by the administration. You have been asked by the administration to present their position. You personally believe the administration is wrong and the batch''s grievance is legitimate.', 'How will you handle this?', 'நிர்வாகத்தால் மோசமாகக் கையாளப்பட்ட ஒரு வசதிகள் பிரச்சினை குறித்து, உங்கள் குழுவினருக்கு நீங்கள் ஒரு பொதுக்கூட்டம் நடத்துகிறீர்கள். அவர்களின் நிலைப்பாட்டை முன்வைக்குமாறு நிர்வாகம் உங்களைக் கேட்டுக்கொண்டுள்ளது. நிர்வாகம் தவறு செய்கிறது என்றும், உங்கள் குழுவினரின் குறை நியாயமானது என்றும் நீங்கள் தனிப்பட்ட முறையில் நம்புகிறீர்கள்.', 'நீங்கள் இதை எப்படிச் சமாளிப்பீர்கள்?',
     '{"theme": "Communication & Influence", "dimension": "conflict_response", "layer": "1", "source": "mba_xlsx_v1"}'::jsonb, true, false)
  RETURNING id
)
INSERT INTO assessment_question_options
...
WITH q AS (
  INSERT INTO assessment_questions
    (assessment_level_id, set_number, program_id,
     ...
     metadata, is_active, is_deleted)
  VALUES ((SELECT id FROM assessment_levels WHERE level_number = 1), 2, (SELECT id FROM programs WHERE code = 'COLLEGE_STUDENT'),
     'A batchmate you respect has approached you about co-founding a startup together. The idea is early but credible. They want a commitment in principle within the next two weeks - they are talking to one other potential co-founder and want to know if you are in before they decide. You came to this MBA with a clear corporate career plan. This is not part of it.', 'How will you proceed now?', 'நீங்கள் மதிக்கும் உங்கள் சக வகுப்பு மாணவர் ஒருவர், உங்களுடன் இணைந்து ஒரு ஸ்டார்ட்அப் நிறுவனத்தைத் தொடங்குவது குறித்துப் பேசியுள்ளார். இந்த யோசனை ஆரம்ப நிலையில் இருந்தாலும், நம்பகமானது. அடுத்த இரண்டு வாரங்களுக்குள் கொள்கை ரீதியான ஒப்புதலை அவர்கள் எதிர்பார்க்கிறார்கள். மற்றொரு சாத்தியமான இணை நிறுவனருடனும் அவர்கள் பேசி வருகிறார்கள், முடிவெடுப்பதற்கு முன்பு நீங்கள் இதில் இணைகிறீர்களா என்பதைத் தெரிந்துகொள்ள விரும்புகிறார்கள். நீங்கள் ஒரு தெளிவான கார்ப்பரேட் தொழில் திட்டத்துடன்தான் இந்த MBA-விற்கு வந்தீர்கள். இது அதன் ஒரு பகுதியல்ல.', 'இனி நீங்கள் எப்படிச் செயல்படுவீர்கள்?',
     '{"theme": "Ambiguity & Risk", "dimension": "change_tolerance", "layer": "1", "source": "mba_xlsx_v1"}'::jsonb, true, false)
  RETURNING id
)
INSERT INTO assessment_question_options
...
WITH q AS (
  INSERT INTO assessment_questions
    (assessment_level_id, set_number, program_id,
     ...
     metadata, is_active, is_deleted)
  VALUES ((SELECT id FROM assessment_levels WHERE level_number = 1), 2, (SELECT id FROM programs WHERE code = 'COLLEGE_STUDENT'),
     'Your faculty advisor has given you written feedback on your thesis proposal saying your research question is interesting but your methodology is not yet defensible. The proposal is due for formal submission in three weeks. Two months of framing have gone into the current approach.', 'How will you handle this?', 'உங்கள் ஆய்வுக் கேள்வி சுவாரஸ்யமாக உள்ளது, ஆனால் உங்கள் ஆய்வு முறை இன்னும் ஏற்றுக்கொள்ளத்தக்கதாக இல்லை என்று உங்கள் துறை ஆலோசகர் உங்கள் ஆய்வறிக்கை முன்மொழிவு குறித்து எழுத்துப்பூர்வமான கருத்தை வழங்கியுள்ளார். இந்த முன்மொழிவை இன்னும் மூன்று வாரங்களில் முறைப்படி சமர்ப்பிக்க வேண்டும். தற்போதைய அணுகுமுறையை வடிவமைப்பதற்கு இரண்டு மாதங்கள் செலவிடப்பட்டுள்ளன.', 'நீங்கள் இதை எப்படிச் சமாளிப்பீர்கள்?',
     '{"theme": "Feedback & Failure", "dimension": "stability_need", "layer": "1", "source": "mba_xlsx_v1"}'::jsonb, true, false)
  RETURNING id
)
INSERT INTO assessment_question_options
...
WITH q AS (
  INSERT INTO assessment_questions
    (assessment_level_id, set_number, program_id,
     ...
     metadata, is_active, is_deleted)
  VALUES ((SELECT id FROM assessment_levels WHERE level_number = 1), 2, (SELECT id FROM programs WHERE code = 'COLLEGE_STUDENT'),
     'You slept through your alarm and missed a core class where cold-calling is a significant part of the participation grade. The professor has a strict attendance policy. It is the first time you have missed this class. You have been running on four to five hours of sleep for eleven consecutive days.', 'How will you handle this?', 'நீங்கள் அலாரத்தை கவனிக்காமல் தூங்கிவிட்டதால், பங்கேற்பு மதிப்பெண்ணில் முன்பின் தெரியாதவர்களைக் கேள்வி கேட்பது ஒரு முக்கியப் பங்கு வகிக்கும் ஒரு முக்கிய வகுப்பைத் தவறவிட்டுவிட்டீர்கள். பேராசிரியருக்குக் கண்டிப்பான வருகைக் கொள்கை உள்ளது. நீங்கள் இந்த வகுப்பைத் தவறவிடுவது இதுவே முதல் முறை. தொடர்ந்து பதினொரு நாட்களாக, நீங்கள் நான்கு முதல் ஐந்து மணி நேரத் தூக்கத்துடன்தான் இருந்து வருகிறீர்கள்.', 'நீங்கள் இதை எப்படிச் சமாளிப்பீர்கள்?',
     '{"theme": "Self-Management & Burnout", "dimension": "decision_speed", "layer": "1", "source": "mba_xlsx_v1"}'::jsonb, true, false)
  RETURNING id
)
INSERT INTO assessment_question_options
...
SELECT q.id, v.ord, v.en, v.ta, v.fac, 1.0, v.meta::jsonb, true, false
FROM q, (VALUES
  (1, 'Email the professor immediately, own it directly, and ask if there is any way to make it up - I will not hide it or over-explain it.', 'உடனடியாகப் பேராசிரியருக்கு மின்னஞ்சல் அனுப்புங்கள், அதை நேரடியாக ஒப்புக்கொண்டு, அதைச் சரிசெய்ய ஏதேனும் வழி இருக்கிறதா என்று கேளுங்கள் - நான் அதை மறைக்கவோ அல்லது தேவைக்கு அதிகமாக விளக்கவோ மாட்டேன்.', 'D', '{"dimension": "decision_speed"}'),
  ...
  (3, 'Send the professor a brief, honest note today acknowledging the absence - not asking for anything specific, just making sure I am not invisible on this.', 'நான் வராததை ஒப்புக்கொண்டு, இன்று பேராசிரியருக்கு ஒரு சுருக்கமான, நேர்மையான குறிப்பை அனுப்புகிறேன் - குறிப்பாக எதையும் கேட்கவில்லை, இந்த விஷயத்தில் நான் கவனிக்கப்படாமல் போய்விடக் கூடாது என்பதை உறுதிப்படுத்திக் கொள்கிறேன்.', 'S', '{"dimension": "decision_speed"}'),
...
WITH q AS (
  INSERT INTO assessment_questions
    (assessment_level_id, set_number, program_id,
     ...
     metadata, is_active, is_deleted)
  VALUES ((SELECT id FROM assessment_levels WHERE level_number = 1), 2, (SELECT id FROM programs WHERE code = 'COLLEGE_STUDENT'),
     'You have committed to three clubs this term, each with real deliverables. You are now at the point where none of the three is getting your genuine best. One club''s event is in two weeks. One has a deliverable due this Friday. One has a leadership transition you promised to support. You cannot sustain all three.', 'How will you prioritize commitments?', 'இந்தப் பருவத்தில் நீங்கள் மூன்று மன்றங்களுக்கு உறுதியளித்துள்ளீர்கள், ஒவ்வொன்றிலும் நிறைவேற்றப்பட வேண்டிய இலக்குகள் உள்ளன. ஆனால் இப்போது, ​​அந்த மூன்றில் எதுவுமே உங்களின் உண்மையான முழு உழைப்பையும் தராத ஒரு நிலைக்கு வந்துள்ளீர்கள். ஒரு மன்றத்தின் நிகழ்ச்சி இன்னும் இரண்டு வாரங்களில் வரவிருக்கிறது. மற்றொன்றில், இந்த வெள்ளிக்கிழமை ஒரு இலக்கை அடைய வேண்டியுள்ளது. இன்னொன்றில், நீங்கள் ஆதரவளிப்பதாக உறுதியளித்த ஒரு தலைமைப் பரிமாற்ற நிகழ்வு நடைபெறுகிறது. இந்த மூன்றையும் உங்களால் தொடர்ந்து ஒரே நேரத்தில் சமாளிக்க முடியாது.', 'உங்கள் கடமைகளுக்கு எவ்வாறு முன்னுரிமை அளிப்பீர்கள்?',
     '{"theme": "Self-Management & Burnout", "dimension": "stability_need", "layer": "1", "source": "mba_xlsx_v1"}'::jsonb, true, false)
  RETURNING id
)
INSERT INTO assessment_question_options
...
WITH q AS (
  ...
  VALUES ((SELECT id FROM assessment_levels WHERE level_number = 1), 3, (SELECT id FROM programs WHERE code = 'COLLEGE_STUDENT'),
     'You are bidding for electives and the window closes in two hours. Your carefully planned combination requires you to win three specific courses. A batchmate has just told you that one of your target electives is massively oversubscribed and you will almost certainly lose it. Changing your bid now means rethinking your entire second year plan under pressure.', 'How will you handle this?', 'நீங்கள் விருப்பப் பாடங்களுக்கு விண்ணப்பித்துள்ளீர்கள், அதற்கான காலக்கெடு இன்னும் இரண்டு மணி நேரத்தில் முடிவடைகிறது. நீங்கள் கவனமாகத் திட்டமிட்ட பாடங்களின் தொகுப்பிற்கு, மூன்று குறிப்பிட்ட பாடங்களில் வெற்றி பெற வேண்டும். உங்கள் இலக்கு விருப்பப் பாடங்களில் ஒன்றிற்கு மிக அதிக விண்ணப்பங்கள் வந்துவிட்டதாகவும், நீங்கள் அதை கிட்டத்தட்ட நிச்சயமாக இழந்துவிடுவீர்கள் என்றும் உங்கள் வகுப்புத் தோழர் ஒருவர் சற்று முன்பு உங்களிடம் கூறியுள்ளார். இப்போது உங்கள் விண்ணப்பத்தை மாற்றுவது என்பது, அழுத்தத்தின் கீழ் உங்கள் இரண்டாம் ஆண்டுக்கான முழுத் திட்டத்தையும் மறுபரிசீலனை செய்வதாகும்.', 'நீங்கள் இதை எப்படிச் சமாளிப்பீர்கள்?',
     '{"theme": "Academic Pressure & Performance", "dimension": "decision_speed", "layer": "1", "source": "mba_xlsx_v1"}'::jsonb, true, false)
  RETURNING id
)
INSERT INTO assessment_question_options
...
WITH q AS (
  INSERT INTO assessment_questions
    (assessment_level_id, set_number, program_id,
     ...
     metadata, is_active, is_deleted)
  VALUES ((SELECT id FROM assessment_levels WHERE level_number = 1), 3, (SELECT id FROM programs WHERE code = 'COLLEGE_STUDENT'),
     'Your team is preparing a final presentation for a live client. One high-performing member has quietly rewritten sections that two other members drafted, without telling them. The rewritten versions are stronger, but the original authors do not know their work was replaced. You found out by accident. Submission is tomorrow.', 'How will you address this?', 'உங்கள் குழு ஒரு நேரடி வாடிக்கையாளருக்காக இறுதி விளக்கக்காட்சியைத் தயாரித்துக் கொண்டிருக்கிறது. சிறப்பாகச் செயல்படும் ஒரு உறுப்பினர், மற்ற இரண்டு உறுப்பினர்கள் வரைந்திருந்த சில பகுதிகளை, அவர்களுக்குத் தெரிவிக்காமல் ரகசியமாகத் திருத்தி எழுதியுள்ளார். திருத்தி எழுதப்பட்ட பதிப்புகள் வலுவாக உள்ளன, ஆனால் தங்கள் படைப்பு மாற்றப்பட்டது அசல் ஆசிரியர்களுக்குத் தெரியாது. நீங்கள் தற்செயலாக இதைக் கண்டுபிடித்துவிட்டீர்கள். நாளை சமர்ப்பிக்க வேண்டும்.', 'நீங்கள் இதை எப்படி கையாள்வீர்கள்?',
     '{"theme": "Team & Group Dynamics", "dimension": "conflict_response", "layer": "1", "source": "mba_xlsx_v1"}'::jsonb, true, false)
  RETURNING id
)
INSERT INTO assessment_question_options
...
WITH q AS (
  INSERT INTO assessment_questions
    (assessment_level_id, set_number, program_id,
     ...
     metadata, is_active, is_deleted)
  VALUES ((SELECT id FROM assessment_levels WHERE level_number = 1), 3, (SELECT id FROM programs WHERE code = 'COLLEGE_STUDENT'),
     'You are leading a cross-batch initiative with no formal budget. You have been trying to get the student affairs office to allocate a small fund for three weeks. They keep redirecting you. The initiative launches in ten days and you need a decision now.', 'How will you handle this?', 'முறையான நிதி ஒதுக்கீடு இல்லாத, பல்வேறு குழுக்களை உள்ளடக்கிய ஒரு முன்னெடுப்பை நீங்கள் வழிநடத்துகிறீர்கள். கடந்த மூன்று வாரங்களாக, ஒரு சிறிய நிதியை ஒதுக்கீடு செய்யுமாறு மாணவர் நல அலுவலகத்திடம் நீங்கள் முயற்சி செய்து வருகிறீர்கள். ஆனால், அவர்கள் உங்களைத் தொடர்ந்து வேறு இடத்திற்கு அனுப்புகிறார்கள். இந்த முன்னெடுப்பு இன்னும் பத்து நாட்களில் தொடங்குகிறது, உங்களுக்கு இப்போதே ஒரு முடிவு தேவை.', 'நீங்கள் இதை எப்படிச் சமாளிப்பீர்கள்?',
     '{"theme": "Leadership & Authority", "dimension": "control_need", "layer": "1", "source": "mba_xlsx_v1"}'::jsonb, true, false)
  RETURNING id
)
INSERT INTO assessment_question_options
...
WITH q AS (
  INSERT INTO assessment_questions
    (assessment_level_id, set_number, program_id,
     ...
     metadata, is_active, is_deleted)
  VALUES ((SELECT id FROM assessment_levels WHERE level_number = 1), 3, (SELECT id FROM programs WHERE code = 'COLLEGE_STUDENT'),
     'You are representing your batch in a faculty grievance about a course that has been consistently poorly managed. The faculty panel has asked for your response in writing by end of day. You have not yet consulted the full batch on the specific wording. You have two hours.', 'How will you submit this?', 'தொடர்ந்து மோசமாக நிர்வகிக்கப்பட்டு வரும் ஒரு பாடநெறி குறித்த பேராசிரியர்களின் குறைதீர்ப்பில், நீங்கள் உங்கள் மாணவர் குழுவின் சார்பாகப் பங்கேற்கிறீர்கள். பேராசிரியர்கள் குழு, அன்றைய தினத்தின் முடிவுக்குள் உங்கள் பதிலை எழுத்துப்பூர்வமாக வழங்குமாறு கேட்டுள்ளது. குறிப்பிட்ட வார்த்தைகள் குறித்து நீங்கள் இன்னும் முழு மாணவர் குழுவிடமும் கலந்தாலோசிக்கவில்லை. உங்களுக்கு இரண்டு மணி நேரம் உள்ளது.', 'இதை எப்படிச் சமர்ப்பிப்பீர்கள்?',
     '{"theme": "Leadership & Authority", "dimension": "decision_speed", "layer": "1", "source": "mba_xlsx_v1"}'::jsonb, true, false)
  RETURNING id
)
INSERT INTO assessment_question_options
...
WITH q AS (
  INSERT INTO assessment_questions
    (assessment_level_id, set_number, program_id,
     ...
     metadata, is_active, is_deleted)
  VALUES ((SELECT id FROM assessment_levels WHERE level_number = 1), 3, (SELECT id FROM programs WHERE code = 'COLLEGE_STUDENT'),
     'You are three months into your MBA. A headhunter has reached out with a full-time role at a firm you genuinely respect - senior to anything you could expect from campus placement and starting immediately after graduation. Taking it seriously means stepping back from the placement process your batch is fully engaged in. The offer has a two-week response window.', 'How will you handle this?', 'நீங்கள் உங்கள் MBA படிப்பைத் தொடங்கி மூன்று மாதங்கள் ஆகின்றன. நீங்கள் உண்மையாகவே மதிக்கும் ஒரு நிறுவனத்தில், ஒரு வேலைவாய்ப்பு முகவர் உங்களைத் தொடர்புகொண்டுள்ளார். வளாகத் தேர்வில் நீங்கள் எதிர்பார்க்கக்கூடியதை விட உயர்வான பதவியாகவும், பட்டப்படிப்பு முடிந்த உடனேயே தொடங்கும் வகையிலும் இந்தப் பணி அமைந்துள்ளது. இதைத் தீவிரமாக எடுத்துக்கொள்வதென்றால், உங்கள் குழுவினர் முழுமையாக ஈடுபட்டுள்ள வேலைவாய்ப்புச் செயல்முறையிலிருந்து நீங்கள் சற்று விலகி நிற்க வேண்டும். இந்த வாய்ப்பு குறித்துப் பதிலளிக்க இரண்டு வார கால அவகாசம் உள்ளது.', 'நீங்கள் இதை எப்படிச் சமாளிப்பீர்கள்?',
     '{"theme": "Career Decisions & Internships", "dimension": "change_tolerance", "layer": "1", "source": "mba_xlsx_v1"}'::jsonb, true, false)
  RETURNING id
)
INSERT INTO assessment_question_options
...
WITH q AS (
  INSERT INTO assessment_questions
    (assessment_level_id, set_number, program_id,
     ...
     metadata, is_active, is_deleted)
  VALUES ((SELECT id FROM assessment_levels WHERE level_number = 1), 3, (SELECT id FROM programs WHERE code = 'COLLEGE_STUDENT'),
     'A batchmate has published a LinkedIn thought piece that is getting significant traction. You recognise two of the central ideas from a group discussion your study group had three weeks ago - ideas you contributed. The article does not reference the conversation or anyone in the group. Several batchmates have already shared it.', 'How will you handle this?', 'என் வகுப்புத் தோழர் ஒருவர் லிங்க்ட்இன் தளத்தில் வெளியிட்ட ஒரு சிந்தனைக் கட்டுரை குறிப்பிடத்தக்க வரவேற்பைப் பெற்று வருகிறது. மூன்று வாரங்களுக்கு முன்பு உங்கள் படிப்புக் குழு நடத்திய ஒரு கலந்துரையாடலில் இடம்பெற்ற, நீங்கள் பங்களித்த இரண்டு மையக் கருத்துக்களை நீங்கள் அடையாளம் காண்கிறீர்கள். அந்தக் கட்டுரை, அந்த உரையாடலையோ அல்லது குழுவில் இருந்த யாரையுமோ குறிப்பிடவில்லை. பல வகுப்புத் தோழர்கள் ஏற்கனவே அதைப் பகிர்ந்துள்ளனர்.', 'நீங்கள் இதை எப்படிச் சமாளிப்பீர்கள்?',
     '{"theme": "Peer Comparison & Competition", "dimension": "approval_need", "layer": "1", "source": "mba_xlsx_v1"}'::jsonb, true, false)
  RETURNING id
)
INSERT INTO assessment_question_options
...
WITH q AS (
  INSERT INTO assessment_questions
    (assessment_level_id, set_number, program_id,
     ...
     metadata, is_active, is_deleted)
  VALUES ((SELECT id FROM assessment_levels WHERE level_number = 1), 3, (SELECT id FROM programs WHERE code = 'COLLEGE_STUDENT'),
     'You are pitching a student initiative to a VC panel as part of a programme competition. One of the panellists - a well-known investor - is visibly unengaged from the first slide. They are checking their phone. The rest of the panel is attentive. You have eight minutes left.', 'How will you handle this?', 'ஒரு நிகழ்ச்சிப் போட்டியின் ஒரு பகுதியாக, நீங்கள் ஒரு மாணவர் முன்னெடுப்பு ஒன்றை துணிகர முதலீட்டாளர் குழுவிடம் முன்வைக்கிறீர்கள். குழு உறுப்பினர்களில் ஒருவரான, நன்கு அறியப்பட்ட முதலீட்டாளர், முதல் ஸ்லைடிலிருந்தே வெளிப்படையாக ஆர்வமின்றி இருக்கிறார். அவர் தனது கைப்பேசியைப் பார்த்துக் கொண்டிருக்கிறார். குழுவின் மற்ற உறுப்பினர்கள் கவனத்துடன் இருக்கிறார்கள். உங்களுக்கு இன்னும் எட்டு நிமிடங்கள் உள்ளன.', 'நீங்கள் இதை எப்படிச் சமாளிப்பீர்கள்?',
     '{"theme": "Communication & Influence", "dimension": "approval_need", "layer": "1", "source": "mba_xlsx_v1"}'::jsonb, true, false)
  RETURNING id
)
INSERT INTO assessment_question_options
...
WITH q AS (
  INSERT INTO assessment_questions
    (assessment_level_id, set_number, program_id,
     ...
     metadata, is_active, is_deleted)
  VALUES ((SELECT id FROM assessment_levels WHERE level_number = 1), 3, (SELECT id FROM programs WHERE code = 'COLLEGE_STUDENT'),
     'A batchmate you respect has approached you about co-founding a startup together. The idea is early but credible. They want a commitment in principle within the next two weeks - they are talking to one other potential co-founder and want to know if you are in before they decide. You came to this MBA with a clear corporate career plan. This is not part of it.', 'How will you handle this?', 'நீங்கள் மதிக்கும் உங்கள் சக வகுப்பு மாணவர் ஒருவர், உங்களுடன் இணைந்து ஒரு ஸ்டார்ட்அப் நிறுவனத்தைத் தொடங்குவது குறித்துப் பேசியுள்ளார். இந்த யோசனை ஆரம்ப நிலையில் இருந்தாலும், நம்பகமானது. அடுத்த இரண்டு வாரங்களுக்குள் கொள்கை ரீதியான ஒப்புதலை அவர்கள் எதிர்பார்க்கிறார்கள். மற்றொரு சாத்தியமான இணை நிறுவனருடனும் அவர்கள் பேசி வருகிறார்கள், முடிவெடுப்பதற்கு முன்பு நீங்கள் இதில் இணைகிறீர்களா என்பதைத் தெரிந்துகொள்ள விரும்புகிறார்கள். நீங்கள் ஒரு தெளிவான கார்ப்பரேட் தொழில் திட்டத்துடன்தான் இந்த MBA-விற்கு வந்தீர்கள். இது அதன் ஒரு பகுதியல்ல.', 'நீங்கள் இதை எப்படிச் சமாளிப்பீர்கள்?',
     '{"theme": "Ambiguity & Risk", "dimension": "change_tolerance", "layer": "1", "source": "mba_xlsx_v1"}'::jsonb, true, false)
  RETURNING id
)
INSERT INTO assessment_question_options
...
WITH q AS (
  INSERT INTO assessment_questions
    (assessment_level_id, set_number, program_id,
     ...
     metadata, is_active, is_deleted)
  VALUES ((SELECT id FROM assessment_levels WHERE level_number = 1), 3, (SELECT id FROM programs WHERE code = 'COLLEGE_STUDENT'),
     'A scholarship has come up that would fund the rest of your MBA in full. The condition is a two-year commitment to work in a geography you are uncertain about after graduation. Applications close in four days. Taking it means locking in a post-graduation path you have not yet decided you want.', 'How will you handle this?', 'உங்கள் MBA படிப்பின் மீதமுள்ள முழுச் செலவிற்கும் நிதியளிக்கும் ஒரு கல்வி உதவித்தொகை அறிவிக்கப்பட்டுள்ளது. பட்டப்படிப்பு முடிந்த பிறகு, நீங்கள் உறுதியாகத் தேர்ந்தெடுக்காத ஒரு புவியியல் பகுதியில் இரண்டு ஆண்டுகள் பணிபுரிய வேண்டும் என்பதே இதற்கான நிபந்தனையாகும். விண்ணப்பங்கள் நான்கு நாட்களில் முடிவடைகின்றன. இந்த உதவித்தொகையை ஏற்றுக்கொள்வதன் மூலம், நீங்கள் இன்னும் தேர்ந்தெடுக்க விரும்பாத ஒரு பட்டப்படிப்புக்குப் பிந்தைய பாதையை உறுதி செய்துகொள்ளலாம்.', 'நீங்கள் இதை எப்படிச் சமாளிப்பீர்கள்?',
     '{"theme": "Ambiguity & Risk", "dimension": "decision_speed", "layer": "1", "source": "mba_xlsx_v1"}'::jsonb, true, false)
  RETURNING id
)
INSERT INTO assessment_question_options
...
WITH q AS (
  INSERT INTO assessment_questions
    (assessment_level_id, set_number, program_id,
     ...
     metadata, is_active, is_deleted)
  VALUES ((SELECT id FROM assessment_levels WHERE level_number = 1), 3, (SELECT id FROM programs WHERE code = 'COLLEGE_STUDENT'),
     'You have committed to three clubs this term, each with real deliverables. You are now at the point where none of the three is getting your genuine best. One club''s event is in two weeks. One has a deliverable due this Friday. One has a leadership transition you promised to support. You cannot sustain all three.', 'How will you manage this?', 'இந்தப் பருவத்தில் நீங்கள் மூன்று மன்றங்களுக்கு உறுதியளித்துள்ளீர்கள், ஒவ்வொன்றிலும் நிறைவேற்றப்பட வேண்டிய இலக்குகள் உள்ளன. ஆனால் இப்போது, ​​அந்த மூன்றில் எதுவுமே உங்களின் உண்மையான முழு உழைப்பையும் தராத ஒரு நிலைக்கு வந்துள்ளீர்கள். ஒரு மன்றத்தின் நிகழ்ச்சி இன்னும் இரண்டு வாரங்களில் வரவிருக்கிறது. மற்றொன்றில், இந்த வெள்ளிக்கிழமை ஒரு இலக்கை அடைய வேண்டியுள்ளது. இன்னொன்றில், நீங்கள் ஆதரவளிப்பதாக உறுதியளித்த ஒரு தலைமைப் பரிமாற்ற நிகழ்வு நடைபெறுகிறது. இந்த மூன்றையும் உங்களால் தொடர்ந்து ஒரே நேரத்தில் சமாளிக்க முடியாது.', 'நீங்கள் இதை எப்படிச் சமாளிப்பீர்கள்?',
     '{"theme": "Self-Management & Burnout", "dimension": "stability_need", "layer": "1", "source": "mba_xlsx_v1"}'::jsonb, true, false)
  RETURNING id
)
INSERT INTO assessment_question_options
