...
const AssessmentSessionsTable: React.FC<AssessmentSessionsTableProps> = ({
    ...
    const getStatusParams = (status: string) => {
        switch (status) {
            case 'ON_GOING': return { label: 'On Going', color: 'bg-[#00B69B]/20 text-[#00B69B] border-[#00B69B]/20' };
            case 'COMPLETED': return { label: 'Completed', color: 'bg-[#00B69B] text-white border-[#00B69B]' };
            case 'EXPIRED': return { label: 'Expired', color: 'bg-[#EF3826]/20 text-[#EF3826] border-[#EF3826]/20' };
            case 'PARTIALLY_EXP': return { label: 'Partially Exp', color: 'bg-[#FFA756]/20 text-[#FFA756] border-[#FFA756]/20' };
                            ...
                            sessions.map((session) => {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <td className="p-4 text-center">
                                            <span className={`px-3 py-1 rounded-full text-[10px] font-semibold border ${status.color}`}>
                                                {status.label}
                                            </span>
                                        </td>
