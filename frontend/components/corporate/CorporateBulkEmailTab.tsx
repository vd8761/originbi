...
interface CorporateBulkEmailTabProps {
...
const CorporateBulkEmailTab: React.FC<CorporateBulkEmailTabProps> = ({ onViewSession, page, entriesPerPage, onTotalChange }) => {
    // ── Data State ──
    ...
    const fetchSessions = useCallback(async () => {
        ...
        try {
            ...
            console.error("CorporateBulkEmailTab fetch failed", err);
        } finally {
            setLoading(false);
        }
                ...
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p className="text-[11px] text-gray-500 dark:text-gray-400 leading-tight">
                            Select completed employees below and queue their report emails.
                            {selectedIds.size > 0 && (
...
export default CorporateBulkEmailTab;
