...
const LoginForm: React.FC<LoginFormProps> = ({
  ...
  return (
    <form className="flex flex-col gap-4 animate-fade-in" style={{ animationDelay: '100ms' }} onSubmit={handleSubmit} noValidate>
