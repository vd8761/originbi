          ...
          {!hideNav && (
            <>
              ...
              <div className="relative" ref={notificationsMenuRef}>
                ...
                {isNotificationsOpen && (
                  <div className="fixed sm:absolute left-4 right-4 sm:left-auto sm:right-0 top-[64px] sm:top-full mt-2 sm:mt-6 w-auto sm:w-[500px] md:w-[540px] notification-glass-card p-0 z-[100] animate-slide-down overflow-hidden text-gray-900 dark:text-white cursor-default">
