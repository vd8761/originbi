    ...
    <div className="relative group">
      <button
        ...
        className={`flex items-center ${spacingClass} rounded-full transition-all duration-200 w-full ${isMobile ? "py-3.5" : "lg:h-10 2xl:h-10"} cursor-pointer ${active
          ...
          : `bg-white border border-gray-200 text-[#19211C] hover:bg-gray-50 hover:text-black hover:border-gray-300 dark:bg-transparent dark:border-white/10 dark:text-white/80 dark:hover:bg-white/5 dark:hover:text-white ${isMobile ? "px-4.5" : "px-3 2xl:px-3.5"}`
          }`}
      >
        <div
          ...
          {!hideNav && (
            <>
              ...
              <div className="relative" ref={notificationsMenuRef}>
                ...
                {isNotificationsOpen && (
                  <div className="fixed sm:absolute left-4 right-4 sm:left-auto sm:right-0 top-[64px] sm:top-full mt-2 sm:mt-6 w-auto sm:w-[500px] md:w-[540px] notification-glass-card p-0 z-50 animate-slide-down overflow-hidden text-gray-900 dark:text-white cursor-default">
