...
export default function CreateJob({ onBack }: CreateJobProps) {
    ...
    return (
        <div className="h-full w-full font-sans bg-[#F8F9FA] dark:bg-[#19211C] text-[#19211C] dark:text-white overflow-y-auto flex justify-center transition-colors duration-200">
                ...
                <div className="flex flex-col xl:flex-row gap-6 mt-2">
                    ...
                    {/* Left Form Column */}
                        <div className="flex-1 min-w-0 flex flex-col w-full mb-8 pb-16">
                            ...
                            <div className="bg-[#F8F9FA] dark:bg-[#2A302C] border border-transparent dark:border-transparent rounded-2xl p-8 flex flex-col gap-0">
                    ...
                    <div className="w-full xl:w-[400px] shrink-0 flex flex-col gap-0 mt-2 xl:mt-0">
                ...
                >
                    ...
                    >
                        ...
                        <div className="sticky top-0 z-10 bg-white/95 dark:bg-[#1F2320]/95 backdrop-blur border-b border-gray-200 dark:border-white/5 px-6 py-4 flex items-center justify-between">
                            ...
                            <button onClick={() => setIsPreviewOpen(false)} className="w-7 h-7 rounded-full bg-gray-100 hover:bg-gray-200 dark:bg-white/10 dark:hover:bg-white/20 flex items-center justify-center text-[#13C065] transition-colors cursor-pointer">
                        ...
                        <div className="p-6 md:p-8 flex flex-col gap-8">
                            ...
                            <div className="flex flex-col md:flex-row md:items-start justify-between gap-6">
                                ...
                                <div className="flex items-center gap-5">
                                    ...
                                    <div className="flex flex-col">
                                        ...
                                        <div className="text-[14px] text-gray-600 dark:text-gray-300 font-medium mb-3">
                                            Google Inc • {jobLocation || "Chennai"} • {employmentType || "Full Time"}
                                        </div>
                                        {/* Dates */}
                                ...
                                <div className="flex items-center gap-3 shrink-0 self-end mb-1">
                                    <button className="px-6 py-2.5 rounded-full text-[13px] font-medium border border-gray-300 dark:border-white/10 text-[#19211C] dark:text-white bg-transparent hover:bg-white/5 transition-colors cursor-pointer">
                                        Save Job
                                    </button>
                                    <button className="px-6 py-2.5 rounded-full text-[13px] font-bold bg-[#13C065] text-white hover:bg-[#10A958] transition-colors cursor-pointer shadow-sm">
                                        Apply Now
                                    </button>
                                </div>
                            </div>
                                ...
                                <div className="w-full bg-[#E5E7EB] dark:bg-[#39403B] border border-transparent dark:border-white/8 rounded-2xl overflow-hidden grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-[1fr_1fr_0.9fr_1fr_1.25fr] gap-px">
                                    ...
                                    <div className="bg-white dark:bg-[#343B36] p-4 flex flex-row items-center gap-4 md:col-span-2 lg:col-span-1 min-w-0">
                                        ...
                                        <div className="flex flex-col min-w-0 flex-1">
                                            ...
                                            <span className="text-[12px] sm:text-[13px] font-semibold text-[#19211C] dark:text-white leading-none mt-1 whitespace-nowrap">
                                                {minCtc} - {maxCtc}
                                            </span>
                                        </div>
                                    </div>
                                ...
                                <div>
                                    ...
                                    <ul className="flex flex-col gap-2.5">
                                        {(responsibilities || "- Design wireframes, UI screens, and simple prototypes\n- Collaborate with developers to ensure accurate design implementation\n- Participate in design discussions and review sessions\n- Assist in improving user experience across products\n- Maintain visual consistency and design standards").split('\n').filter(Boolean).map((resp, idx) => (
                                            <li key={idx} className="flex flex-row items-start gap-2 text-gray-700 dark:text-gray-300">
...
function RichTextArea({ label, required, completed, value, onChange, maxLength }: any) {
    return (
        <div className="flex flex-col gap-2">
            ...
            <div className="bg-white dark:bg-[#555B57] border border-gray-200 dark:border-transparent rounded-[24px] overflow-hidden transition-colors">
                {/* Toolbar */}
