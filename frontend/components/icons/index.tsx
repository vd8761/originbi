...
export const EditPencilIcon: React.FC<{ className?: string }> = ({
  ...
  >
    <path d="M10.6094 3.88574L1.02461 13.4705C0.671427 13.8243 0.448216 14.2872 0.391217 14.7838L0.0093175 18.1371C-0.0155769 18.3729 0.0095497 18.6113 0.0830564 18.8368C0.156563 19.0622 0.276797 19.2696 0.435905 19.4454C0.595013 19.6212 0.789417 19.7615 1.00642 19.857C1.22343 19.9526 1.45815 20.0013 1.69526 20H1.89087L5.24413 19.6181C5.73884 19.5609 6.20066 19.3414 6.55749 18.9941L16.1422 9.4L10.6094 3.88574Z" fill="currentColor" />
    <path d="M19.3837 3.07532L16.9526 0.644203C16.7492 0.44002 16.5075 0.278005 16.2414 0.167456C15.9752 0.0569071 15.6899 0 15.4017 0C15.1135 0 14.8282 0.0569071 14.562 0.167456C14.2959 0.278005 14.0542 0.44002 13.8508 0.644203L11.5967 2.89834L17.1296 8.43122L19.3837 6.17709C19.5879 5.97371 19.7499 5.73202 19.8604 5.46588C19.971 5.19974 20.0279 4.91439 20.0279 4.6262C20.0279 4.33801 19.971 4.05266 19.8604 3.78652C19.7499 3.52038 19.5879 3.27869 19.3837 3.07532Z" fill="currentColor" />
  </svg>
);
...
export const CircleArrowUpIcon: React.FC<{ className?: string }> = ({ className = "w-5 h-5" }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export const FilterFunnelIcon: React.FC<{ className?: string }> = ({ className = "w-5 h-5" }) => (
...
export const CrossRightArrowIcon: React.FC<{ className?: string }> = ({
  className = "w-4 h-4",
}) => (
  <svg
    className={className}
...
export const CoinIcon: React.FC<{ className?: string }> = ({
  className = "w-5 h-5",
}) => (
  <svg
    className={className}
    ...
    xmlns="http://www.w3.org/2000/svg"
  >
    <g clipPath="url(#clip0_343_579)">
      <path
        d="M12.0007 23.6102C18.4028 23.6102 23.625 18.3946 23.625 11.9992C23.625 5.60384 18.4028 0.389648 12.0007 0.389648C5.59861 0.389648 0.375 5.60524 0.375 11.9992C0.375 18.3932 5.5972 23.6102 12.0007 23.6102Z"
        fill="#FB8500"
      />
      <path
        d="M12.0007 0.389648C5.5972 0.389648 0.375 5.60524 0.375 11.9992C0.375 18.3932 5.5972 23.6102 12.0007 23.6102C18.4042 23.6102 23.625 18.3946 23.625 11.9992C23.625 5.60384 18.4028 0.389648 12.0007 0.389648ZM12.0007 20.8629C7.1122 20.8629 3.12572 16.8815 3.12572 11.9992C3.12572 7.11687 7.1122 3.13544 12.0007 3.13544C16.8892 3.13544 20.8757 7.11827 20.8757 11.9992C20.8757 16.8801 16.8878 20.8629 12.0007 20.8629Z"
        fill="#FFB703"
      />
      <path
        d="M3.78711 3.7961L5.73027 5.73677C7.33794 4.13112 9.55653 3.13549 12.0007 3.13549V0.389648C8.79926 0.389648 5.89306 1.69329 3.78711 3.7961Z"
        fill="#FCD227"
      />
      <path
        d="M20.2146 20.2024L18.2714 18.2617C16.6635 19.8675 14.4447 20.863 12.001 20.863V23.6102C15.2023 23.6102 18.1086 22.3061 20.2145 20.2024L20.2146 20.2024Z"
        fill="#FCD227"
      />
      <path
        d="M20.2133 3.79663L18.2705 5.73697C19.8784 7.34277 20.8753 9.55869 20.8753 11.9991H23.6247C23.6247 8.80218 22.3191 5.89977 20.2133 3.79663Z"
        fill="#FCD227"
      />
      <path
        d="M3.78652 20.203L5.73 18.262C4.12233 16.6563 3.12567 14.4404 3.12567 11.9993H0.375C0.375 15.1969 1.68056 18.0997 3.78652 20.203Z"
        fill="#FCD227"
      />
      <path
        d="M15.9859 11.5195C15.9859 11.5195 15.9859 11.5194 15.9858 11.5194L12.6529 6.9847C12.4954 6.77132 12.2636 6.65381 12.0001 6.65381C11.7366 6.65381 11.5048 6.77132 11.347 6.98512L8.01428 11.5195C7.80381 11.8064 7.80381 12.192 8.01442 12.4792L11.3473 17.0138C11.5048 17.2272 11.7366 17.3447 12.0001 17.3447C12.2636 17.3447 12.4954 17.2272 12.6532 17.0134L15.9859 12.4791C16.1965 12.1921 16.1965 11.8065 15.9859 11.5195H15.9859Z"
        fill="#FCD227"
      />
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M12
.7013V2.29887C7.99961e-06 2.10047 0.0695086 1.90874 0.195742 1.75889C0.321984 1.60905 0.497272 1.51114 0.687966 1.48316ZM12.0002 1.58451H15.2C15.4122 1.58451 15.6157 1.67132 15.7657 1.82584C15.9158 1.98036 16 2.18993 16 2.40846V15.5917C16 15.8102 15.9158 16.0197 15.7657 16.1743C15.6157 16.3288 15.4122 16.4156 15.2 16.4156H12.0002V1.58451ZM6.56046 9.00008L8.80035 5.70426H6.88045L5.60053 7.58783L4.32059 5.70426H2.40068L4.64057 9.00008L2.40068 12.2959H4.32059L5.60053 10.4123L6.88045 12.2959H8.80035L6.56046 9.00008Z" />
  </svg>
);

export const BulkUploadIcon: React.FC<{ className?: string }> = ({
  className = "w-4 h-4",
}) => (
  <svg
    className={className}
  ...
  >
    <path
      d="M17.182 9.81812C16.965 9.81812 16.7569 9.90432 16.6034 10.0578C16.45 10.2112 16.3638 10.4193 16.3638 10.6363V14.0833C16.3631 14.6879 16.1227 15.2675 15.6952 15.695C15.2677 16.1225 14.6881 16.363 14.0835 16.3636H3.91667C3.3121 16.363 2.73248 16.1225 2.30498 15.695C1.87748 15.2675 1.63703 14.6879 1.63638 14.0833V10.6363C1.63638 10.4193 1.55018 10.2112 1.39674 10.0578C1.2433 9.90432 1.03519 9.81812 0.81819 9.81812C0.601192 9.81812 0.393082 9.90432 0.239642 10.0578C0.0862018 10.2112 0 10.4193 0 10.6363V14.0833C0.00108294 15.1218 0.414079 16.1174 1.14836 16.8516C1.88265 17.5859 2.87824 17.9989 3.91667 18H14.0835C15.1219 17.9989 16.1175 17.5859 16.8518 16.8516C17.5861 16.1174 17.9991 15.1218 18.0002 14.0833V10.6363C18.0002 10.4193 17.914 10.2112 17.7605 10.0578C17.6071 9.90432 17.399 9.81812 17.182 9.81812Z"
      fill="currentColor"
    />
    <path
      d="M4.6698 6.30561L8.18229 2.79312V13.0909C8.18229 13.3079 8.26849 13.516 8.42193 13.6694C8.57537 13.8228 8.78348 13.909 9.00048 13.909C9.21747 13.909 9.42558 13.8228 9.57902 13.6694C9.73246 13.516 9.81867 13.3079 9.81867 13.0909V2.79312L13.3312 6.30561C13.4855 6.45465 13.6921 6.53712 13.9067 6.53526C14.1212 6.53339 14.3264 6.44735 14.4781 6.29565C14.6298 6.14395 14.7159 5.93874 14.7177 5.72421C14.7196 5.50968 14.6371 5.30301 14.4881 5.14869L9.57894 0.239555C9.4255 0.086168 9.21743 0 9.00048 0C8.78352 0 8.57545 0.086168 8.42202 0.239555L3.51288 5.14869C3.36384 5.30301 3.28137 5.50968 3.28323 5.72421C3.2851 5.93874 3.37115 6.14395 3.52285 6.29565C3.67454 6.44735 3.87976 6.53339 4.09428 6.53526C4.30881 6.53712 4.51549 6.45465 4.6698 6.30561Z"
      fill="currentColor"
    />
  </svg>
);
...
export const ArrowLeftWithoutLineIcon: React.FC<{ className?: string }> = ({ className = "w-2 h-4" }) => (
  <svg width="8" height="15" viewBox="0 0 8 15" fill="currentColor" xmlns="http://www.w3.org/2000/svg" className={className}>
    <path d="M6.64138 13.974C6.83776 14.1708 7.15614 14.1708 7.35252 13.974C7.54888 13.7771 7.54888 13.458 7.35252 13.2612L1.16689 7.06091L7.35272 0.860465C7.5491 0.663641 7.5491 0.344506 7.35272 0.147665C7.15634 -0.0491756 6.83796 -0.0491756 6.6416 0.147665L0.147496 6.65711C0.0375747 6.7673 -0.0108157 6.91578 0.00230841 7.0597C-0.0115198 7.20431 0.0368034 7.35375 0.147278 7.4645L6.64138 13.974Z" fill="currentColor" />
  </svg>
);
...
export const EyeSolidIcon: React.FC<{ className?: string }> = ({
  className = "w-5 h-5",
}) => (
...
export const SortIcon: React.FC<{
  ...
  >
    <path
      d="M5 0L9.33013 5H0.669873L5 0Z"
      fill={sort === "asc" ? "#1ED36A" : "#6B7280"}
      className="transition-colors duration-200"
    />
    <path
      d="M5 16L0.669873 11H9.33013L5 16Z"
      fill={sort === "desc" ? "#1ED36A" : "#6B7280"}
      className="transition-colors duration-200"
    />
  </svg>
);
...
export const LeftArrowIcon: React.FC<{ className?: string }> = ({ className = "w-5 h-5" }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="M19 12H5M12 19l-7-7 7-7" />
  </svg>
);

export const GroupsIcon: React.FC<{ className?: string }> = ({ className = "w-5 h-5" }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export const BanIcon: React.FC<{ className?: string }> = ({
  className = "w-4 h-4",
}) => (
  <svg
    className={className}
  ...
  >
    <path
      fillRule="evenodd"
      clipRule="evenodd"
      d="M12 2C6.48 2 2 6.48 2 12C2 17.52 6.48 22 12 22C17.52 22 22 17.52 22 12C22 6.48 17.52 2 12 2ZM12 20C7.59 20 4 16.41 4 12C4 10.15 4.63 8.45 5.69 7.1L16.9 18.31C15.55 19.37 13.85 20 12 20ZM18.31 16.9L7.1 5.69C8.45 4.63 10.15 4 12 4C16.41 4 20 7.59 20 12C20 13.85 19.37 15.55 18.31 16.9Z"
    />
  </svg>
);
...
export const NoNotificationsIcon: React.FC<{ className?: string }> = ({ className = "" }) => (
  <svg className={className} width="165" height="200" viewBox="0 0 165 200" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M76.6289 1C85.7608 1 93.1729 8.41198 93.1729 17.5439C93.1728 21.8713 91.4556 25.8397 88.6738 28.7871L87.4678 30.0654L89.1816 30.4492C94.4366 31.6276 99.4251 33.4833 104.04 35.9307C97.2889 43.0414 93.1377 52.6215 93.1377 63.1582C93.1378 85.0087 110.884 102.755 132.734 102.755C133.588 102.755 134.42 102.718 135.243 102.661V144.035C135.243 147.229 137.115 150.178 139.991 151.536L139.994 151.538C146.215 154.448 150.532 160.267 151.57 167.063L151.699 167.913H151.732L152.199 171.014V171.015C152.44 172.762 151.931 174.51 150.784 175.873C149.642 177.196 147.989 177.948 146.243 177.948H7.01562C5.27217 177.948 3.62159 177.198 2.47949 175.879C1.32846 174.515 0.81625 172.764 1.05762 171.014L1.65332 167.063C2.69125 160.267 7.00818 154.448 13.2285 151.538L13.2314 151.536C16.1077 150.178 17.9805 147.229 17.9805 144.035V87.7197C17.9805 59.7098 37.782 36.2118 64.0713 30.4502L65.7969 30.0723L64.584 28.7871C61.8015 25.8389 60.085 21.9053 60.085 17.5439C60.085 8.41201 67.4971 1.00005 76.6289 1Z" stroke="white" strokeWidth="2" />
    <path d="M132.735 31.5785C115.297 31.5785 101.156 45.7189 101.156 63.1575C101.156 80.5961 115.297 94.7365 132.735 94.7365C150.174 94.7365 164.314 80.5961 164.314 63.1575C164.314 45.7189 150.174 31.5785 132.735 31.5785ZM147.612 73.0873C148.981 74.4558 148.981 76.6663 147.612 78.0347C146.91 78.7365 146.033 79.0523 145.121 79.0523C144.209 79.0523 143.331 78.7014 142.63 78.0347L132.7 68.1049L122.77 78.0347C122.068 78.7365 121.191 79.0523 120.279 79.0523C119.367 79.0523 118.49 78.7014 117.788 78.0347C116.419 76.6663 116.419 74.4558 117.788 73.0873L127.718 63.1575L117.788 53.2276C116.419 51.8592 116.419 49.6487 117.788 48.2803C119.156 46.9118 121.367 46.9118 122.735 48.2803L132.665 58.2101L142.595 48.2803C143.963 46.9118 146.174 46.9118 147.542 48.2803C148.91 49.6487 148.91 51.8592 147.542 53.2276L137.612 63.1575L147.542 73.0873H147.612Z" fill="#1ED36A" />
  </svg>
);
