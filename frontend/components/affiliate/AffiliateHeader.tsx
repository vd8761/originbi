            ...
            <div className="w-full max-w-[2000px] mx-auto px-4 sm:px-6 lg:px-8 2xl:px-12 py-3 sm:py-4 flex items-center justify-between h-full">
                ...
                <div className="flex items-center gap-1 sm:gap-2 lg:gap-2 2xl:gap-4">
                    ...
                    <div className="relative" ref={notificationsMenuRef}>
                        ...
                        {isNotificationsOpen && (
                            <div className="absolute right-0 top-full mt-6 w-[340px] sm:w-[480px] md:w-[540px] glass-card p-0 z-50 animate-slide-down overflow-hidden text-gray-900 dark:text-white cursor-default">
