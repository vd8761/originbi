...
const testimonials: TestimonialData[] = [
    {
        quote: "OriginBI's affiliate program has been incredible. I've helped dozens of companies find better talent while earning great commissions.",
        name: 'Arun Prasad',
        title: 'Senior Affiliate Partner',
    },
    {
        quote: "The referral tracking is seamless. I always know exactly how my referrals are performing and what I've earned.",
        name: 'Priya Sharma',
        title: 'Education Consultant & Affiliate',
    },
    {
        quote: "Joining as an affiliate was the best decision. The platform practically sells itself, and the support team is outstanding.",
        name: 'Vikram Nair',
        title: 'HR Consultant & Top Affiliate',
    },
];
        ...
        <div className="relative w-full h-full bg-brand-dark-secondary rounded-3xl overflow-hidden p-6 md:p-8 lg:p-[5%] flex flex-col justify-end shadow-2xl">
            ...
            <div className="absolute inset-0 z-0">
                <img
                    ...
                    alt="Affiliate partnership background"
            ...
            <div key={currentIndex} className="relative z-20 flex flex-col justify-end h-full">
                ...
                <style jsx global>{`
          @keyframes affiliateFillProgress {
            from { width: 0%; }
            to { width: 100%; }
          }
          .animate-affiliate-fill {
            animation: affiliateFillProgress 5000ms linear forwards;
          }
        `}</style>
