...
const JobItem: React.FC<JobItemProps> = ({
    ...
    <div className="bg-[#19211C]/5 dark:bg-white/5 rounded-2xl p-4 lg:p-[1vw] flex flex-col h-full border border-transparent hover:border-brand-green/30 transition-all duration-300">
        <div className="flex justify-between items-start mb-4">
            <div className="flex items-center space-x-3">
                ...
                <div>
                    ...
                    <p className="text-white text-[10px] lg:text-[0.729vw] mt-0.5">{company} | {location}</p>
                </div>
            </div>
            <div className="text-right">
                <p className="text-[10px] lg:text-[0.729vw] font-medium text-white">
        ...
        <div className="flex flex-wrap gap-2 mb-4">
            <span className="flex items-center space-x-1.5 text-[10px] lg:text-[0.729vw] text-white">
        ...
        <div className="flex flex-wrap gap-2 mt-auto">
            ...
            <span className="text-white text-[9px] lg:text-[0.625vw] ml-auto self-center mt-1">
                {postedDate}
            </span>
        </div>
    </div>
