  ...
  return (
    <div className="relative w-full min-h-[100dvh] overflow-hidden bg-[#FAFAFA] dark:bg-brand-dark-primary transition-colors duration-300">
      ...
      <div className="relative z-10 w-full max-w-[1920px] mx-auto grid grid-cols-1 lg:grid-cols-12 h-screen px-[clamp(24px,8.33vw,160px)]">
        ...
        <div className="order-1 lg:col-span-5 flex flex-col justify-start gap-4 h-full py-[clamp(16px,2vw,32px)] relative overflow-y-auto lg:overflow-hidden z-10 [&::-webkit-scrollbar]:hidden [-ms-overflow-style:'none'] [scrollbar-width:'none']">
          {/* Header */}
